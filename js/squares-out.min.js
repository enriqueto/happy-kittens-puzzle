...
(function (SquaresOut) {
    ...
    SquaresOut.AudioButton = AudioButton;
})(SquaresOut || (SquaresOut = {}));
var SquaresOut;
(function (SquaresOut) {
...
(function (SquaresOut) {
    var GUI = (function (_super) {
        ...
        function GUI(game) {
            ...
            var audioButton = new SquaresOut.AudioButton(_this.game, 410, 25);
...
(function (SquaresOut) {
    var HUD = (function (_super) {
        ...
        function HUD(game) {
            ...
            var levelBest = SquaresOut.GameVars.levelsBestResults[SquaresOut.GameVars.currentLevel - 1];
...
(function (SquaresOut) {
    var LevelManager = (function () {
        function LevelManager(game) {
            ...
            SquaresOut.GameVars.currentLevel = SquaresOut.GameVars.currentLevel || 1;
...
(function (SquaresOut) {
    var Square = (function (_super) {
        ...
        function Square(game, color, column, row) {
            ...
            _this.square.scale.set((SquaresOut.GameConstants.SQUARE_WIDTH - 9) / 64);
            ...
            if (_this.color === SquaresOut.GameConstants.WHITE_SQUARE) {
        ...
        Square.prototype.update = function () {
            ...
            if (this.flipping) {
                if (this.framesCounter === 6) {
                    this.flipping = false;
                    this.square.frameName = this.color === SquaresOut.GameConstants.WHITE_SQUARE ? "switch_off.png" : "switch_on.png";
                }
                this.framesCounter++;
            }
        };
        Square.prototype.flip = function () {
            ...
            this.square.frameName = this.color === SquaresOut.GameConstants.WHITE_SQUARE ? "switch_on_off.png" : "switch_off_on.png";
        };
...
(function (SquaresOut) {
    var GameManager = (function () {
        ...
        GameManager.init = function (game) {
            ...
            var bestResultsStr = SquaresOut.GameVars.getLocalStorageData(SquaresOut.GameConstants.LEVEL_BEST_KEY);
            if (bestResultsStr !== "") {
                SquaresOut.GameVars.levelsBestResults = JSON.parse(bestResultsStr);
            }
            else {
                SquaresOut.GameVars.levelsBestResults = [];
                SquaresOut.GameVars.levelsBestResults[0] = 0;
                for (var i = 1; i < SquaresOut.GameConstants.TOTAL_LEVELS; i++) {
                    SquaresOut.GameVars.levelsBestResults[i] = -1;
                }
                SquaresOut.GameVars.setLocalStorageData(SquaresOut.GameConstants.LEVEL_BEST_KEY, JSON.stringify(SquaresOut.GameVars.levelsBestResults));
            }
        };
        ...
        GameManager.levelPassed = function () {
            var record = SquaresOut.GameVars.levelsBestResults[SquaresOut.GameVars.currentLevel - 1];
            if (SquaresOut.GameVars.levelsBestResults[SquaresOut.GameVars.currentLevel - 1] === 0 || SquaresOut.GameVars.moves < record) {
                SquaresOut.GameVars.levelsBestResults[SquaresOut.GameVars.currentLevel - 1] = SquaresOut.GameVars.moves;
            }
            if (SquaresOut.GameVars.currentLevel < SquaresOut.GameConstants.TOTAL_LEVELS) {
                SquaresOut.GameVars.currentLevel++;
            }
            SquaresOut.GameVars.levelsBestResults[SquaresOut.GameVars.currentLevel - 1] = 0;
            SquaresOut.GameVars.setLocalStorageData(SquaresOut.GameConstants.LEVEL_BEST_KEY, JSON.stringify(SquaresOut.GameVars.levelsBestResults));
        };
        return GameManager;
    }());
...
(function (SquaresOut) {
    var LevelSelection = (function (_super) {
        ...
        LevelSelection.prototype.create = function () {
            ...
            var audioButton = new SquaresOut.AudioButton(this.game, 400, 35);
        ...
        LevelSelection.prototype.setCurrentLevelPage = function () {
            var achievedLevel = 1;
            for (var i = 0; i < SquaresOut.GameVars.levelsBestResults.length; i++) {
                if (SquaresOut.GameVars.levelsBestResults[i] === 0) {
                    achievedLevel = i + 1;
                    break;
                }
            }
            ...
            this.levelsRail.x = -SquaresOut.GameConstants.GAME_WIDTH * this.indexLevelsPage;
        };
...
(function (SquaresOut) {
    var LevelSelectionButton = (function (_super) {
        ...
        function LevelSelectionButton(game, level) {
            ...
            _this.level = level;
            var isBlocked = SquaresOut.GameVars.levelsBestResults[level - 1] === -1 ? true : false;
