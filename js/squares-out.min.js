    ...
    var Board = (function (_super) {
        ...
        function Board(game) {
            ...
            for (var i = 0; i < 5; i++) {
                _this.squares[i] = [];
                for (var j = 0; j < 5; j++) {
                    color = SquaresOut.GameVars.colors[i][j];
                    square = new SquaresOut.Square(_this.game, color, i, j);
                    square.x = i * SquaresOut.GameConstants.SQUARE_WIDTH;
                    square.y = j * SquaresOut.GameConstants.SQUARE_WIDTH;
                    _this.add(square);
...
(function (SquaresOut) {
    ...
    SquaresOut.BoardManager = BoardManager;
})(SquaresOut || (SquaresOut = {}));
var SquaresOut;
(function (SquaresOut) {
    var BoardState = (function (_super) {
        ...
        BoardState.prototype.init = function () {
            ...
            this.boardManager = new SquaresOut.BoardManager(this.game);
...
(function (SquaresOut) {
    var Square = (function (_super) {
        ...
        Square.prototype.onClick = function () {
            this.flip();
            SquaresOut.BoardManager.currentInstance.squareFlipped(this.column, this.row);
        };
