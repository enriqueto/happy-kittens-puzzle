...
(function (SquaresOut) {
    var LevelsContainer = (function (_super) {
        ...
        function LevelsContainer(game) {
            var _this = _super.call(this, game, null, "level-container") || this;
            var levelSelectionButton;
            for (var col = 0; col < 3; col++) {
                for (var row = 0; row < 4; row++) {
                    levelSelectionButton = new SquaresOut.LevelSelectionButton(_this.game, (col + 1) + 3 * row);
                    levelSelectionButton.x = SquaresOut.GameConstants.GAME_WIDTH / 2 - 80 * (1 - col);
                    levelSelectionButton.y = SquaresOut.GameConstants.GAME_HEIGHT / 2 - 80 * (2 - row);
...
(function (SquaresOut) {
    var LevelSelection = (function (_super) {
        ...
        LevelSelection.prototype.create = function () {
            ...
            var levelsContainer = new SquaresOut.LevelsContainer(this.game);
