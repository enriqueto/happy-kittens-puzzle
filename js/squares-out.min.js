...
(function (Xhungo) {
    var AudioManager = (function () {
        ...
        AudioManager.prototype.init = function (game) {
            ...
            var audioStateStr = Xhungo.GameVars.getLocalStorageData(Xhungo.GameConstants.AUDIO_STATE_KEY);
            if (audioStateStr !== "") {
        ...
        AudioManager.prototype.mute = function () {
            ...
            Xhungo.GameVars.setLocalStorageData(Xhungo.GameConstants.AUDIO_STATE_KEY, JSON.stringify(this.isMuted));
        };
    ...
    Xhungo.AudioManager = AudioManager;
})(Xhungo || (Xhungo = {}));
var Xhungo;
(function (Xhungo) {
    var Board = (function (_super) {
        ...
        function Board(game) {
            ...
            _this.x = Xhungo.GameConstants.GAME_WIDTH / 2 - 2 * Xhungo.GameConstants.SQUARE_WIDTH;
            _this.y = Xhungo.GameConstants.GAME_HEIGHT / 2 - 2 * Xhungo.GameConstants.SQUARE_WIDTH;
            _this.squares = [];
            var square;
            var color;
            for (var i = 0; i < 5; i++) {
...
(function (Xhungo) {
    var BoardManager = (function () {
        function BoardManager(game) {
            ...
            this.game = game;
            Xhungo.GameVars.currentLevel = 1;
...
(function (Xhungo) {
    var Square = (function (_super) {
        ...
        function Square(game, color, column, row) {
            ...
            _this.redSquare.scale.set((Xhungo.GameConstants.SQUARE_WIDTH - 6) / 64);
            ...
            _this.whiteSquare.scale.set((Xhungo.GameConstants.SQUARE_WIDTH - 6) / 64);
            ...
            _this.overSprite.scale.set((Xhungo.GameConstants.SQUARE_WIDTH - 6) / 64);
...
(function (Xhungo) {
    var Boot = (function (_super) {
        ...
        Boot.prototype.init = function () {
            ...
            Xhungo.GameManager.init(this.game);
        };
...
(function (Xhungo) {
    ...
    Xhungo.GameManager = GameManager;
})(Xhungo || (Xhungo = {}));
var Xhungo;
(function (Xhungo) {
