...
(function (SquaresOut) {
    var LevelsContainer = (function (_super) {
        ...
        function LevelsContainer(game) {
            ...
            var levelSelectionButton = new SquaresOut.LevelSelectionButton(_this.game, 1);
...
(function (SquaresOut) {
    var LevelSelectionButton = (function (_super) {
        ...
        function LevelSelectionButton(game, level) {
            ...
            _this.buttonSprite.scale.set(50 / 65);
            ...
            var levelLabel = new Phaser.Text(_this.game, 0, 0, "90", { font: "30px Arial", fill: "#FFFFFF" });
