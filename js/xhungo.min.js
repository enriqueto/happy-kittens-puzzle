...
(function (Xhungo) {
    var Board = (function (_super) {
        ...
        function Board(game) {
            ...
            _this.x = Xhungo.GameConstants.GAME_WIDTH / 2 - 3.5 * Xhungo.GameConstants.SQUARE_WIDTH;
            _this.y = Xhungo.GameConstants.GAME_HEIGHT / 2 - 3.5 * Xhungo.GameConstants.SQUARE_WIDTH;
            _this.squares = [];
            var square;
            var color;
            for (var i = 0; i < 8; i++) {
                _this.squares[i] = [];
                for (var j = 0; j < 8; j++) {
                    color = Xhungo.GameVars.colors[i][j];
                    square = new Xhungo.Square(_this.game, color, i, j);
            ...
            var graphics = new Phaser.Graphics(_this.game, 0, 0);
            _this.add(graphics);
            graphics.lineStyle(1, 0xffd900, 1);
            for (var i = 0; i < 8; i++) {
                graphics.moveTo(-Xhungo.GameConstants.SQUARE_WIDTH / 2, (i - .5) * Xhungo.GameConstants.SQUARE_WIDTH);
                graphics.lineTo(Xhungo.GameConstants.SQUARE_WIDTH * 7.5, (i - .5) * Xhungo.GameConstants.SQUARE_WIDTH);
                graphics.moveTo((i - .5) * Xhungo.GameConstants.SQUARE_WIDTH, -Xhungo.GameConstants.SQUARE_WIDTH / 2);
                graphics.lineTo((i - .5) * Xhungo.GameConstants.SQUARE_WIDTH, Xhungo.GameConstants.SQUARE_WIDTH * 7.5);
            }
            return _this;
        }
        return Board;
...
(function (Xhungo) {
    var BoardManager = (function () {
        function BoardManager(game) {
            ...
            this.game = game;
            Xhungo.GameVars.level = 1;
            Xhungo.GameVars.colors = [];
            ...
            for (var col = 0; col < 8; col++) {
                ...
                for (var row = 0; row < 8; row++) {
                    ...
                    if (r === 0xff && g === 0x00 && b === 0x00) {
                        Xhungo.GameVars.colors[col].push(Xhungo.GameConstants.RED_SQUARE);
                    }
                    if (r === 0xff && g === 0xff && b === 0xff) {
                        Xhungo.GameVars.colors[col].push(Xhungo.GameConstants.WHITE_SQUARE);
                    }
                }
            }
        }
        BoardManager.prototype.squareFlipped = function (column, row) {
            var squares = Xhungo.BoardState.currentInstance.board.squares;
            var c;
            var r;
...
(function (Xhungo) {
    var Square = (function (_super) {
        ...
        function Square(game, color, column, row) {
            ...
            _this.column = column;
            _this.row = row;
            _this.redSquare = new Phaser.Sprite(_this.game, 0, 0, _this.game.cache.getBitmapData(Xhungo.GameConstants.RED_SQUARE));
            _this.redSquare.scale.set(Xhungo.GameConstants.SQUARE_WIDTH / 64);
            ...
            _this.whiteSquare = new Phaser.Sprite(_this.game, 0, 0, _this.game.cache.getBitmapData(Xhungo.GameConstants.WHITE_SQUARE));
            _this.whiteSquare.scale.set(Xhungo.GameConstants.SQUARE_WIDTH / 64);
            ...
            if (_this.color === Xhungo.GameConstants.RED_SQUARE) {
                _this.whiteSquare.visible = false;
            }
            else {
                _this.redSquare.visible = false;
            }
            _this.overSprite = new Phaser.Sprite(_this.game, 0, 0, _this.game.cache.getBitmapData(Xhungo.GameConstants.GRAY_SQUARE));
        ...
        Square.prototype.onClick = function () {
            this.flip();
            Xhungo.BoardManager.currentInstance.squareFlipped(this.column, this.row);
        };
...
(function (Xhungo) {
    ...
    Xhungo.LevelSelection = LevelSelection;
})(Xhungo || (Xhungo = {}));
var Xhungo;
(function (Xhungo) {
    var PreLoader = (function (_super) {
        ...
        PreLoader.prototype.generateBitmapData = function () {
            ...
            bmd.ctx.fill();
            bmd = this.game.add.bitmapData(64, 64, Xhungo.GameConstants.GRAY_SQUARE, true);
            bmd.ctx.beginPath();
            bmd.ctx.rect(0, 0, 64, 64);
