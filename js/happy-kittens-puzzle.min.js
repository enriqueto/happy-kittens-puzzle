    ...
    var Boot = (function (_super) {
        ...
        Boot.prototype.init = function () {
            ...
            if (this.game.device.desktop) {
                ...
                HappyKittensPuzzle.GameVars.upperStripeScale = 1;
                this.game.scale.scaleMode = Phaser.ScaleManager.SHOW_ALL;
                this.game.scale.pageAlignHorizontally = true;
            }
            else {
                ...
                if (aspectRatio === 4 / 3) {
                    ...
                    HappyKittensPuzzle.GameVars.upperStripeScale = .8;
                }
...
(function (HappyKittensPuzzle) {
    var CreditsState = (function (_super) {
        ...
        CreditsState.prototype.create = function () {
            ...
            yellowStripe.y = HappyKittensPuzzle.GameVars.upperStripe_py;
...
(function (HappyKittensPuzzle) {
    var YellowStripe = (function (_super) {
        ...
        function YellowStripe(game, text) {
            ...
            _this.x = HappyKittensPuzzle.GameConstants.GAME_WIDTH / 2;
            _this.y = HappyKittensPuzzle.GameVars.upperStripe_py;
            _this.scale.set(HappyKittensPuzzle.GameVars.upperStripeScale, HappyKittensPuzzle.GameVars.upperStripeScale * HappyKittensPuzzle.GameVars.scaleY);
