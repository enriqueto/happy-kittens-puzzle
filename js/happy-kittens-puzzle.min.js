...
(function (HappyKittensPuzzle) {
    var Game = (function (_super) {
        ...
        function Game() {
            ...
            _this.state.add("SplashState", HappyKittensPuzzle.SplashState, false);
            ...
            _this.state.add("CreditsState", HappyKittensPuzzle.CreditsState, false);
...
(function (HappyKittensPuzzle) {
    var BoardState = (function (_super) {
        ...
        BoardState.prototype.init = function () {
            ...
            this.boardManager = new HappyKittensPuzzle.LevelManager(this.game);
        };
        ...
        BoardState.prototype.shutdown = function () {
            HappyKittensPuzzle.SplashState.currentInstance = null;
    ...
    var Cell = (function (_super) {
        ...
        function Cell(game, state, column, row) {
            ...
            if (_this.game.device.desktop) {
                _this.overImage = new Phaser.Image(_this.game, 0, 0, "texture_atlas_1", "rollover_grumpy_cat.png");
        ...
        Cell.prototype.over = function () {
            ...
            this.overImage.frameName = this.state === HappyKittensPuzzle.GameConstants.GRUMPY ? "rollover_grumpy_cat.png" : "rollover_happy_cat.png";
        };
        Cell.prototype.out = function () {
            this.overImage.visible = false;
        };
        Cell.prototype.onClick = function () {
            if (HappyKittensPuzzle.GameVars.levelPassed && !HappyKittensPuzzle.GameConstants.EDITING_LEVELS) {
                return;
            }
            this.flip(true);
            ...
            if (HappyKittensPuzzle.GameConstants.EDITING_LEVELS) {
                ...
                HappyKittensPuzzle.LevelManager.currentInstance.cellFlipped(this.column, this.row);
            }
            this.game.time.events.add(250, function () {
                var rnd = Math.random();
                if (rnd < .33) {
                    HappyKittensPuzzle.AudioManager.getInstance().playSound(this.state === HappyKittensPuzzle.GameConstants.GRUMPY ? "grumpy_cat_01" : "happy_cat_01");
                }
                else if (rnd < .66) {
                    HappyKittensPuzzle.AudioManager.getInstance().playSound(this.state === HappyKittensPuzzle.GameConstants.GRUMPY ? "grumpy_cat_02" : "happy_cat_02");
                }
                else {
                    HappyKittensPuzzle.AudioManager.getInstance().playSound(this.state === HappyKittensPuzzle.GameConstants.GRUMPY ? "grumpy_cat_03" : "happy_cat_03");
                }
            }, this);
        };
        Cell.prototype.onOver = function () {
            ...
            if (!HappyKittensPuzzle.GameConstants.EDITING_LEVELS) {
                HappyKittensPuzzle.LevelManager.currentInstance.cellOver(this.column, this.row);
            }
        ...
        Cell.prototype.onOut = function () {
            ...
            if (!HappyKittensPuzzle.GameConstants.EDITING_LEVELS) {
                HappyKittensPuzzle.LevelManager.currentInstance.cellOut(this.column, this.row);
            }
        };
        return Cell;
    }(Phaser.Group));
...
(function (HappyKittensPuzzle) {
    var GUI = (function (_super) {
        ...
        function GUI(game) {
            ...
            var audioButton = new HappyKittensPuzzle.AudioButton(_this.game, HappyKittensPuzzle.AudioButton.PX, HappyKittensPuzzle.AudioButton.PY);
            var yellowStripe = HappyKittensPuzzle.BoardState.currentInstance.hud.yellowStripe;
            yellowStripe.add(audioButton);
            _this.exitButton = new Phaser.Button(_this.game, 40, 914, "texture_atlas_1", _this.onExitClicked, _this);
            _this.exitButton.setFrames("button-exit-on.png", "button-exit-off.png", "button-exit-on.png");
            _this.exitButton.scale.y = HappyKittensPuzzle.GameVars.scaleY;
            _this.add(_this.exitButton);
            _this.resetButton = new Phaser.Button(_this.game, 140, 914, "texture_atlas_1", _this.onResetClicked, _this);
            _this.resetButton.setFrames("button-reset-on.png", "button-reset-off.png", "button-reset-on.png");
            _this.resetButton.scale.y = HappyKittensPuzzle.GameVars.scaleY;
            _this.add(_this.resetButton);
            return _this;
        }
        GUI.prototype.onResetClicked = function () {
            HappyKittensPuzzle.LevelManager.currentInstance.resetLevel();
        };
        GUI.prototype.onExitClicked = function () {
            HappyKittensPuzzle.LevelManager.currentInstance.exit();
        };
        return GUI;
    }(Phaser.Group));
...
(function (HappyKittensPuzzle) {
    var HUD = (function (_super) {
        ...
        function HUD(game) {
            ...
            _this.yellowStripe.y = 20;
            _this.add(_this.yellowStripe);
            var lowerContainer = new Phaser.Group(_this.game);
            lowerContainer.scale.y = HappyKittensPuzzle.GameVars.scaleY;
            lowerContainer.y = 900;
            _this.add(lowerContainer);
            var lowerStripe = new Phaser.Sprite(_this.game, 0, 0, _this.game.cache.getBitmapData(HappyKittensPuzzle.GameConstants.BLACK_SQUARE));
            lowerStripe.scale.set(HappyKittensPuzzle.GameConstants.GAME_WIDTH / 64, 100 / 64);
            lowerStripe.alpha = .5;
            lowerContainer.add(lowerStripe);
            var movesLabel = new Phaser.Text(_this.game, 650, 5, "MOVES:", { font: "40px Concert One", fill: "#FFFFFF" });
            movesLabel.anchor.x = 1;
            lowerContainer.add(movesLabel);
            _this.moves = new Phaser.Text(_this.game, 680, 5, HappyKittensPuzzle.GameVars.moves.toString(), { font: "40px Concert One", fill: "#FFFFFF" });
            lowerContainer.add(_this.moves);
            var levelBest = HappyKittensPuzzle.GameVars.levelsBestResults[HappyKittensPuzzle.GameVars.currentLevel - 1];
            if (levelBest > 0) {
                var bestLabel = new Phaser.Text(_this.game, 650, 50, "LEVEL'S BEST:", { font: "40px Concert One", fill: "#FFFFFF" });
                bestLabel.anchor.x = 1;
                lowerContainer.add(bestLabel);
                var best = new Phaser.Text(_this.game, 680, 50, levelBest.toString(), { font: "40px Concert One", fill: "#FFFFFF" });
...
(function (HappyKittensPuzzle) {
    var LevelManager = (function () {
        ...
        LevelManager.prototype.cellOver = function (column, row) {
        ...
        LevelManager.prototype.cellOut = function (column, row) {
            var c;
            var r;
            var cells = HappyKittensPuzzle.BoardState.currentInstance.board.cells;
            for (var i = 0; i < LevelManager.neighbourSquares.length; i++) {
        ...
        LevelManager.prototype.cellFlipped = function (column, row) {
    ...
    HappyKittensPuzzle.LevelManager = LevelManager;
})(HappyKittensPuzzle || (HappyKittensPuzzle = {}));
var HappyKittensPuzzle;
(function (HappyKittensPuzzle) {
    ...
    var Boot = (function (_super) {
        ...
        Boot.prototype.init = function () {
            ...
            if (this.game.device.desktop) {
                ...
                HappyKittensPuzzle.GameVars.scaleY = (4 / 3) / (window.innerHeight / window.innerWidth);
                this.game.scale.pageAlignHorizontally = true;
...
(function (HappyKittensPuzzle) {
    var CreditsState = (function (_super) {
        ...
        CreditsState.prototype.create = function () {
            ...
            var yellowStripe = new HappyKittensPuzzle.YellowStripe(this.game, "CREDITS");
            yellowStripe.y = 50;
            this.add.existing(yellowStripe);
            var backButton = new Phaser.Button(this.game, 640, 20, "texture_atlas_1", this.onBackClicked, this);
            backButton.setFrames("button-exit-on.png", "button-exit-off.png", "button-exit-on.png");
            yellowStripe.add(backButton);
            var itemsContainer = new Phaser.Group(this.game);
            itemsContainer.position.set(HappyKittensPuzzle.GameConstants.GAME_WIDTH / 2, 430);
            itemsContainer.scale.y = HappyKittensPuzzle.GameVars.scaleY;
            this.add.existing(itemsContainer);
            var label = new Phaser.Text(this.game, 0, -200, "a game by:", { font: "70px Concert One", fill: "#FFFFFF" });
            label.anchor.x = .5;
            label.setShadow(4, 4, "rgba(0, 0, 0, .6)", 0);
            itemsContainer.add(label);
            var ravalmaticLogo = new Phaser.Image(this.game, 0, 0, "texture_atlas_1", "logo-ravalmatic.png");
            ...
            label.setShadow(4, 4, "rgba(0, 0, 0, .6)", 0);
            itemsContainer.add(label);
            var banana = new Phaser.Image(this.game, 305, 308, "texture_atlas_1", "banana.png");
            banana.anchor.set(.5);
            ...
            pulseTween.loop();
            pulseTween.start();
            var lowerItemsContainer = new Phaser.Group(this.game);
            lowerItemsContainer.position.set(0, HappyKittensPuzzle.GameConstants.GAME_HEIGHT - 80);
            lowerItemsContainer.scale.y = HappyKittensPuzzle.GameVars.scaleY;
    ...
    HappyKittensPuzzle.CreditsState = CreditsState;
})(HappyKittensPuzzle || (HappyKittensPuzzle = {}));
var HappyKittensPuzzle;
(function (HappyKittensPuzzle) {
    ...
    GameConstants.SQUARE_WIDTH = 136;
    GameConstants.TIME_FADE = 350;
    GameConstants.TOTAL_LEVELS = 60;
    GameConstants.LEVEL_BEST_KEY = "lights-on-levels-best-results";
...
(function (HappyKittensPuzzle) {
    var GameManager = (function () {
        ...
        GameManager.init = function (game) {
            ...
            HappyKittensPuzzle.GameVars.currentLevel = null;
        ...
        GameManager.levelPassed = function () {
            ...
            if (HappyKittensPuzzle.GameVars.levelsBestResults[HappyKittensPuzzle.GameVars.currentLevel - 1] === 0 || HappyKittensPuzzle.GameVars.moves < record) {
            ...
            HappyKittensPuzzle.GameVars.levelsBestResults[HappyKittensPuzzle.GameVars.currentLevel - 1] = 0;
            HappyKittensPuzzle.GameVars.setLocalStorageData(HappyKittensPuzzle.GameConstants.LEVEL_BEST_KEY, JSON.stringify(HappyKittensPuzzle.GameVars.levelsBestResults));
        };
        return GameManager;
    }());
...
(function (HappyKittensPuzzle) {
    var LevelSelectionButton = (function (_super) {
        ...
        function LevelSelectionButton(game, level) {
            ...
            _this.level = level;
            var isBlocked = HappyKittensPuzzle.GameVars.levelsBestResults[level - 1] === -1 ? true : false;
            if (isBlocked) {
    ...
    LevelSelectionButton.leavingScene = false;
...
(function (HappyKittensPuzzle) {
    var LevelSelectionState = (function (_super) {
        ...
        LevelSelectionState.prototype.create = function () {
            ...
            backgroundImage.anchor.set(.5);
            backgroundImage.scale.y = HappyKittensPuzzle.GameVars.scaleY;
            var yellowStripe = new HappyKittensPuzzle.YellowStripe(this.game, "SELECT STAGE");
            yellowStripe.y = 50;
            this.add.existing(yellowStripe);
            ...
            for (var i = 0; i < LevelSelectionState.LEVEL_PAGES; i++) {
                ...
                levelsContainer.y = HappyKittensPuzzle.GameConstants.GAME_HEIGHT / 2;
                this.levelsRail.add(levelsContainer);
            }
            this.previousButton = this.add.button(60, HappyKittensPuzzle.GameConstants.GAME_HEIGHT / 2, "texture_atlas_1", this.onArrowClick, this);
            ...
            this.nextButton = this.add.button(700, HappyKittensPuzzle.GameConstants.GAME_HEIGHT / 2, "texture_atlas_1", this.onArrowClick, this);
            ...
            var audioButton = new HappyKittensPuzzle.AudioButton(this.game, HappyKittensPuzzle.AudioButton.PX, HappyKittensPuzzle.AudioButton.PY);
            yellowStripe.add(audioButton);
...
(function (HappyKittensPuzzle) {
    var LevelEditionState = (function (_super) {
        ...
        LevelEditionState.prototype.move = function (column, row) {
            ...
            var c;
            var r;
            for (var i = 0; i < HappyKittensPuzzle.LevelManager.neighbourSquares.length; i++) {
                c = HappyKittensPuzzle.LevelManager.neighbourSquares[i][0] + column;
                r = HappyKittensPuzzle.LevelManager.neighbourSquares[i][1] + row;
...
(function (HappyKittensPuzzle) {
    var PreLoader = (function (_super) {
        ...
        PreLoader.prototype.composeScene = function () {
            var gameTitle = this.add.text(HappyKittensPuzzle.GameConstants.GAME_WIDTH / 2, 190, "abc", { font: "60px Concert One", fill: "#FF1493" });
            gameTitle.anchor.x = .5;
            var backgroundSprite = this.add.sprite(0, 0, this.game.cache.getBitmapData(HappyKittensPuzzle.GameConstants.GRUMPY));
            ...
            var preloadBarCapsuleShadow = new Phaser.Sprite(this.game, HappyKittensPuzzle.GameConstants.GAME_WIDTH / 2 + 2, 200 + 2, this.game.cache.getBitmapData(HappyKittensPuzzle.GameConstants.BLUE_SQUARE));
            ...
            var preloadBarCapsule = new Phaser.Sprite(this.game, HappyKittensPuzzle.GameConstants.GAME_WIDTH / 2, 200, this.game.cache.getBitmapData(HappyKittensPuzzle.GameConstants.GREEN_SQUARE));
            preloadBarCapsule.scale.setTo(14.65, .85);
            preloadBarCapsule.anchor.set(.5);
            preloadBarContainer.add(preloadBarCapsule);
            this.preloadBar = new Phaser.Sprite(this.game, HappyKittensPuzzle.GameConstants.GAME_WIDTH / 2 - 116, 200, this.game.cache.getBitmapData(HappyKittensPuzzle.GameConstants.WHITE_SQUARE));
            this.preloadBar.scale.setTo(0, .6);
            this.preloadBar.anchor.set(0, .5);
            preloadBarContainer.add(this.preloadBar);
            this.loadingLabel = this.add.text(HappyKittensPuzzle.GameConstants.GAME_WIDTH / 2, 190, "Loading", { font: "60px Concert One", fill: "#FF1493" });
...
(function (HappyKittensPuzzle) {
    var SplashState = (function (_super) {
        ...
        SplashState.prototype.create = function () {
            var backgroundSprite = this.add.sprite(0, 0, this.game.cache.getBitmapData(HappyKittensPuzzle.GameConstants.GRUMPY));
            backgroundSprite.scale.set(HappyKittensPuzzle.GameConstants.GAME_WIDTH / 64, HappyKittensPuzzle.GameConstants.GAME_HEIGHT / 64);
            var gameTitle = this.add.text(HappyKittensPuzzle.GameConstants.GAME_WIDTH / 2, 190, "Happy Kittens Puzzle", { font: "60px Concert One", fill: "#FF1493" });
            gameTitle.anchor.x = .5;
            var creditsButton = this.add.button(680, 150, "texture_atlas_1", this.onClickCredits, this);
            creditsButton.setFrames("button-credits-on.png", "button-credits-off.png", "button-credits-on.png");
            creditsButton.anchor.set(.5);
            creditsButton.scale.y = HappyKittensPuzzle.GameVars.scaleY;
            creditsButton.forceOut = true;
            var playButton = this.add.button(HappyKittensPuzzle.GameConstants.GAME_WIDTH / 2, HappyKittensPuzzle.GameConstants.GAME_HEIGHT / 2, "texture_atlas_1", this.onClickPlay, this);
            playButton.setFrames("button-play-on.png", "button-play-off.png", "button-play-on.png");
            playButton.anchor.set(.5);
            playButton.scale.y = HappyKittensPuzzle.GameVars.scaleY;
            playButton.forceOut = true;
            var audioButton = new HappyKittensPuzzle.AudioButton(this.game, 600, 35);
            this.add.existing(audioButton);
            var copyrightLabel = this.add.text(6, HappyKittensPuzzle.GameConstants.GAME_HEIGHT - 8, "made by ravalmatic, licensed to: " + HappyKittensPuzzle.GameConstants.SPONSOR, { font: "20px Arial", fill: "#000000" });
        ...
        SplashState.prototype.onClickCredits = function () {
            if (this.leavingScene) {
                return;
            }
            this.leavingScene = true;
    ...
    HappyKittensPuzzle.SplashState = SplashState;
})(HappyKittensPuzzle || (HappyKittensPuzzle = {}));
var HappyKittensPuzzle;
(function (HappyKittensPuzzle) {
    var YellowStripe = (function (_super) {
        ...
        function YellowStripe(game, text) {
            ...
            colorStripe.scale.set(HappyKittensPuzzle.GameConstants.GAME_WIDTH / 64, 12 / 64);
            ...
            colorStripe.scale.set(HappyKittensPuzzle.GameConstants.GAME_WIDTH / 64, 90 / 64);
            _this.add(colorStripe);
            ...
            colorStripe.scale.set(HappyKittensPuzzle.GameConstants.GAME_WIDTH / 64, 12 / 64);
            _this.add(colorStripe);
            colorStripe = new Phaser.Sprite(_this.game, 0, colorStripe.y + colorStripe.height, _this.game.cache.getBitmapData(HappyKittensPuzzle.GameConstants.BLACK_SQUARE));
            colorStripe.scale.set(HappyKittensPuzzle.GameConstants.GAME_WIDTH / 64, 16 / 64);
            colorStripe.alpha = .5;
            _this.add(colorStripe);
            var stripeLabel = new Phaser.Text(_this.game, HappyKittensPuzzle.GameConstants.GAME_WIDTH / 2, 18, text, { font: "70px Concert One", fill: "#FFFFFF" });
