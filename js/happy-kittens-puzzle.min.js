...
(function (HappyKittensPuzzle) {
    var LevelSelectionState = (function (_super) {
        ...
        LevelSelectionState.prototype.create = function () {
            ...
            var creditsLabel = this.add.text(HappyKittensPuzzle.GameConstants.GAME_WIDTH / 2, HappyKittensPuzzle.GameConstants.GAME_HEIGHT - 38, "made by ravalmatic, licensed to " + HappyKittensPuzzle.GameConstants.SPONSOR, { font: "30px Arial", fill: "#FFFFFF" });
