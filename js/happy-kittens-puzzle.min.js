...
(function (HappyKittensPuzzle) {
    var AudioButton = (function (_super) {
        ...
        AudioButton.prototype.onAudioButtonClicked = function () {
            if (HappyKittensPuzzle.AudioManager.getInstance().isMuted) {
...
(function (HappyKittensPuzzle) {
    var Board = (function (_super) {
        ...
        function Board(game) {
            ...
            _this.y = HappyKittensPuzzle.GameConstants.GAME_HEIGHT / 2;
            _this.cells = [];
            var cell;
            var state;
...
(function (HappyKittensPuzzle) {
    var Cell = (function (_super) {
        ...
        function Cell(game, state, column, row) {
            ...
            _this.cellBack = _this.create(0, 0, "texture_atlas_1", "happy_kitten_idle.png");
            _this.cellBack.anchor.set(.5);
            _this.cellBack.inputEnabled = true;
            _this.cellBack.events.onInputDown.add(_this.onClick, _this);
            _this.cellFront = _this.create(0, 0, "texture_atlas_1", "grumpy_kitten_idle.png");
            _this.cellFront.anchor.set(.5);
            _this.cellFront.inputEnabled = true;
            _this.cellFront.events.onInputDown.add(_this.onClick, _this);
            if (_this.game.device.desktop) {
                _this.cellBack.events.onInputOver.add(_this.onOver, _this);
                _this.cellBack.events.onInputOut.add(_this.onOut, _this);
                _this.cellFront.events.onInputOver.add(_this.onOver, _this);
                _this.cellFront.events.onInputOut.add(_this.onOut, _this);
            }
            if (_this.state === HappyKittensPuzzle.GameConstants.GRUMPY) {
                _this.cellBack.scale.set(0);
                _this.cellBack.visible = false;
            }
            else {
                _this.cellFront.scale.set(0);
                _this.cellFront.visible = false;
            }
            return _this;
        }
        ...
        Cell.prototype.onClick = function () {
            ...
            if (HappyKittensPuzzle.GameConstants.EDITING_LEVELS) {
                ...
                HappyKittensPuzzle.LevelManager.currentInstance.squareFlipped(this.column, this.row);
            }
        };
...
(function (HappyKittensPuzzle) {
    var GUI = (function (_super) {
        ...
        function GUI(game) {
            ...
            var audioButton = new HappyKittensPuzzle.AudioButton(_this.game, 600, 25);
            var yellowStripe = HappyKittensPuzzle.BoardState.currentInstance.hud.yellowStripe;
            yellowStripe.add(audioButton);
            _this.exitButton = new Phaser.Button(_this.game, 40, 905, "texture_atlas_1", _this.onExitClicked, _this);
            ...
            _this.resetButton = new Phaser.Button(_this.game, 140, 905, "texture_atlas_1", _this.onResetClicked, _this);
...
(function (HappyKittensPuzzle) {
    var Square = (function (_super) {
        ...
        function Square(game, color, column, row) {
            ...
            _this.column = column;
            _this.row = row;
            _this.square = new Phaser.Image(_this.game, 0, 0, "texture_atlas_1", "happy_kitten_idle.png");
            _this.square.anchor.set(.5);
            _this.square.inputEnabled = true;
            _this.square.events.onInputDown.add(_this.onClick, _this);
            _this.add(_this.square);
            if (_this.color === HappyKittensPuzzle.GameConstants.GRUMPY) {
                _this.square.frameName = "grumpy_kitten_idle.png";
            }
            return _this;
        }
        Square.prototype.flip = function () {
            ...
            this.color = this.color === HappyKittensPuzzle.GameConstants.HAPPY ? HappyKittensPuzzle.GameConstants.GRUMPY : HappyKittensPuzzle.GameConstants.HAPPY;
            this.square.frameName = this.color === HappyKittensPuzzle.GameConstants.GRUMPY ? "switch_on_off.png" : "switch_off_on.png";
        };
    ...
    HappyKittensPuzzle.Square = Square;
})(HappyKittensPuzzle || (HappyKittensPuzzle = {}));
var HappyKittensPuzzle;
(function (HappyKittensPuzzle) {
...
(function (HappyKittensPuzzle) {
    ...
    GameConstants.SPONSOR = GameConstants.GAMEPIX;
        ...
        function LevelsContainer(game, i) {
            ...
            for (var col = 0; col < 3; col++) {
                for (var row = 0; row < 4; row++) {
                    levelSelectionButton = new HappyKittensPuzzle.LevelSelectionButton(_this.game, i * 12 + (col + 1) + 3 * row);
...
(function (HappyKittensPuzzle) {
    var LevelSelectionButton = (function (_super) {
        ...
        function LevelSelectionButton(game, level) {
            ...
            _this.buttonSprite = new Phaser.Sprite(_this.game, 0, 0, _this.game.cache.getBitmapData(HappyKittensPuzzle.GameConstants.HAPPY));
            _this.buttonSprite.scale.set(120 / 65);
            ...
            var levelLabel = new Phaser.Text(_this.game, 0, 0, _this.level.toString(), { font: "60px Concert One", fill: "#FFFFFF" });
        ...
        LevelSelectionButton.prototype.onClick = function () {
            ...
            this.buttonSprite.loadTexture(this.game.cache.getBitmapData(HappyKittensPuzzle.GameConstants.BLUE_SQUARE));
        ...
        LevelSelectionButton.prototype.onOver = function () {
            this.buttonSprite.loadTexture(this.game.cache.getBitmapData(HappyKittensPuzzle.GameConstants.GREEN_SQUARE));
        };
        LevelSelectionButton.prototype.onOut = function () {
            this.buttonSprite.loadTexture(this.game.cache.getBitmapData(HappyKittensPuzzle.GameConstants.HAPPY));
        };
...
(function (HappyKittensPuzzle) {
    var LevelSelectionState = (function (_super) {
        ...
        LevelSelectionState.prototype.create = function () {
            ...
            var audioButton = new HappyKittensPuzzle.AudioButton(this.game, 640, 25);
            yellowStripe.add(audioButton);
    ...
    LevelSelectionState.NEXT = "previous";
...
(function (HappyKittensPuzzle) {
    var YellowStripe = (function (_super) {
        ...
        function YellowStripe(game, text) {
            ...
            colorStripe.alpha = .5;
            _this.add(colorStripe);
            var levelLabel = new Phaser.Text(_this.game, HappyKittensPuzzle.GameConstants.GAME_WIDTH / 2, 16, text, { font: "70px Concert One", fill: "#FFFFFF" });
            levelLabel.anchor.x = .5;
            levelLabel.scale.y = HappyKittensPuzzle.GameVars.scaleY;
