...
=======
            var bmd = new Phaser.BitmapData(BoardManager.game, "tmp-bitmapdata", 8, 8);
...
(function (HappyKittensPuzzle) {
    var GUI = (function (_super) {
        ...
        function GUI(game) {
            ...
            _this.exitButton = new Phaser.Button(_this.game, 200 / HappyKittensPuzzle.GameVars.stripesScale, 16, "texture_atlas_1", _this.onExitClicked, _this);
            _this.exitButton.setFrames("button-exit-on.png", "button-exit-off.png", "button-exit-on.png");
            lowerStripe.add(_this.exitButton);
            _this.resetButton = new Phaser.Button(_this.game, 280 / HappyKittensPuzzle.GameVars.stripesScale, 16, "texture_atlas_1", _this.onResetClicked, _this);
...
<<<<<<< HEAD
            var movesLabel = new Phaser.Text(_this.game, -150 / HappyKittensPuzzle.GameVars.stripesScale, 5, "MOVES:", { font: "40px Concert One", fill: "#FFFFFF" });
            movesLabel.anchor.x = 1;
            _this.lowerStripe.add(movesLabel);
            _this.moves = new Phaser.Text(_this.game, -130 / HappyKittensPuzzle.GameVars.stripesScale, 5, HappyKittensPuzzle.GameVars.moves.toString(), { font: "40px Concert One", fill: "#FFFFFF" });
=======
            var movesLabel = new Phaser.Text(_this.game, -350 / HappyKittensPuzzle.GameVars.stripesScale, 5, "MOVES:", { font: "40px Concert One", fill: "#FFFFFF" });
            _this.lowerStripe.add(movesLabel);
            _this.moves = new Phaser.Text(_this.game, -100 / HappyKittensPuzzle.GameVars.stripesScale, 5, HappyKittensPuzzle.GameVars.moves.toString(), { font: "40px Concert One", fill: "#FFFFFF" });
>>>>>>> develop
            ...
            if (levelBest > 0) {
<<<<<<< HEAD
                var bestLabel = new Phaser.Text(_this.game, -60 / HappyKittensPuzzle.GameVars.stripesScale, 50, "LEVEL'S BEST:", { font: "40px Concert One", fill: "#FFFFFF" });
                bestLabel.anchor.x = 1;
                _this.lowerStripe.add(bestLabel);
                var best = new Phaser.Text(_this.game, -50 / HappyKittensPuzzle.GameVars.stripesScale, 50, levelBest.toString(), { font: "40px Concert One", fill: "#FFFFFF" });
=======
                var bestLabel = new Phaser.Text(_this.game, -350 / HappyKittensPuzzle.GameVars.stripesScale, 50, "LEVEL'S BEST:", { font: "40px Concert One", fill: "#FFFFFF" });
                _this.lowerStripe.add(bestLabel);
