...
(function (HappyKittensPuzzle) {
    var AudioButton = (function (_super) {
        ...
        function AudioButton(game, x, y) {
            ...
            var mark = new Phaser.Image(_this.game, -3, -3, "texture_atlas_1", "button-audio-mark.png");
            mark.visible = false;
...
(function (HappyKittensPuzzle) {
    var GUI = (function (_super) {
        ...
        function GUI(game) {
            ...
            var audioButton = new HappyKittensPuzzle.AudioButton(_this.game, HappyKittensPuzzle.AudioButton.PX / HappyKittensPuzzle.GameVars.stripesScale, HappyKittensPuzzle.AudioButton.PY);
            ...
            _this.exitButton = new Phaser.Button(_this.game, 60 / HappyKittensPuzzle.GameVars.stripesScale, 5, "texture_atlas_1", _this.onExitClicked, _this);
            ...
            _this.resetButton = new Phaser.Button(_this.game, 84.375 / HappyKittensPuzzle.GameVars.stripesScale, 5, "texture_atlas_1", _this.onResetClicked, _this);
