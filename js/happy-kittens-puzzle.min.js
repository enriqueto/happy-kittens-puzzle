    ...
    var HUD = (function (_super) {
        ...
        function HUD(game) {
            ...
            if (levelBest > 0) {
                ...
                var best = new Phaser.Text(_this.game, -106.25 / HappyKittensPuzzle.GameVars.stripesScale, 15.625, levelBest.toString(), { font: "12.5px Concert One", fill: "#FFFFFF" });
...
(function (HappyKittensPuzzle) {
    var LevelSelectionButton = (function (_super) {
        ...
        function LevelSelectionButton(game, level) {
            ...
            var levelLabel = new Phaser.Text(_this.game, 0, -2.8, _this.level.toString(), { font: "19px Concert One", fill: "#FFFFFF" });
