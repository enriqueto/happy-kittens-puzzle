...
(function (HappyKittensPuzzle) {
    var Cell = (function (_super) {
        ...
        function Cell(game, state, column, row) {
            ...
            _this.happyKitten.animations.add("meow", Phaser.Animation.generateFrameNames("happy_kitten_meow_", 1, 9, ".png", 4));
            _this.happyKitten.play("meow", 24, true);
            ...
            _this.grumpyKitten.animations.add("meow", Phaser.Animation.generateFrameNames("grumpy_kitten_meow_", 1, 11, ".png", 4));
            _this.grumpyKitten.play("meow", 24, true);
...
(function (HappyKittensPuzzle) {
    var GUI = (function (_super) {
        ...
        function GUI(game) {
            ...
            var audioButton = new HappyKittensPuzzle.AudioButton(_this.game, 600, 20);
...
(function (HappyKittensPuzzle) {
    var HUD = (function (_super) {
        ...
        function HUD(game) {
            ...
            _this.moves = new Phaser.Text(_this.game, 675, 5, HappyKittensPuzzle.GameVars.moves.toString(), { font: "40px Concert One", fill: "#FFFFFF" });
            ...
            if (levelBest > 0) {
                var best = new Phaser.Text(_this.game, 675, 50, levelBest.toString(), { font: "40px Concert One", fill: "#FFFFFF" });
