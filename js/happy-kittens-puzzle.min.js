...
(function (HappyKittensPuzzle) {
    var HUD = (function (_super) {
        ...
        function HUD(game) {
            ...
            _this.yellowStripe = new HappyKittensPuzzle.YellowStripe(_this.game, "TEST LVL " + HappyKittensPuzzle.GameVars.currentLevel);
            ...
            var movesLabel = new Phaser.Text(_this.game, -340 / HappyKittensPuzzle.GameVars.stripesScale, 5, "MOVES:", { font: "40px Concert One", fill: "#FFFFFF" });
            _this.lowerStripe.add(movesLabel);
            _this.moves = new Phaser.Text(_this.game, -225 / HappyKittensPuzzle.GameVars.stripesScale, 5, HappyKittensPuzzle.GameVars.moves.toString(), { font: "40px Concert One", fill: "#FFFFFF" });
