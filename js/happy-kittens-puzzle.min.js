...
(function (HappyKittensPuzzle) {
    var GameConstants = (function () {
        ...
        GameConstants.LOGICIEL_EDUCATIF = "Logiciel Educatif";
        GameConstants.NONE = "none";
        GameConstants.SPONSOR = GameConstants.LOGICIEL_EDUCATIF;
...
(function (HappyKittensPuzzle) {
    var PreLoader = (function (_super) {
        ...
        PreLoader.prototype.create = function () {
            ...
            if (HappyKittensPuzzle.GameConstants.EDITING_LEVELS) {
                ...
                if (HappyKittensPuzzle.GameConstants.SPONSOR === HappyKittensPuzzle.GameConstants.GAMEPIX) {
                    ...
                    if (HappyKittensPuzzle.GameConstants.SPONSOR === HappyKittensPuzzle.GameConstants.NONE) {
        ...
        PreLoader.prototype.composeScene = function () {
            ...
            this.loadingLabel = this.add.text(HappyKittensPuzzle.GameConstants.GAME_WIDTH / 2, 475, "chargement...", { font: "66px Concert One", fill: "#FFFFFF" });
...
(function (HappyKittensPuzzle) {
    var YellowStripe = (function (_super) {
        ...
        function YellowStripe(game, text, hasLogo) {
            ...
            if (hasLogo) {
                var logo = new Phaser.Image(_this.game, -HappyKittensPuzzle.GameConstants.GAME_WIDTH / 2 + 5, 45, "texture_atlas_1", "logicieleducatif.png");
                _this.add(logo);
            }
            return _this;
        }
...
(function (HappyKittensPuzzle) {
    var BoardManager = (function () {
        ...
        BoardManager.cellFlipped = function (col, row) {
            ...
            if (HappyKittensPuzzle.GameConstants.SPONSOR === HappyKittensPuzzle.GameConstants.COOLGAMES && BoardManager.timerEvent === null) {
        ...
        BoardManager.resetLevel = function () {
            if (HappyKittensPuzzle.GameConstants.SPONSOR === HappyKittensPuzzle.GameConstants.GAMEPIX) {
                GamePix.game.ping("game_over", { score: 0, level: HappyKittensPuzzle.GameVars.currentLevel, achievements: {} });
            }
...
(function (HappyKittensPuzzle) {
    var BoardState = (function (_super) {
        ...
        BoardState.prototype.create = function () {
            ...
            if (HappyKittensPuzzle.GameConstants.SPONSOR === HappyKittensPuzzle.GameConstants.FUNO && !BoardState.funoStartWithoutAudio) {
...
(function (HappyKittensPuzzle) {
    var HUD = (function (_super) {
        ...
        function HUD(game) {
            ...
            _this.yellowStripe = new HappyKittensPuzzle.YellowStripe(_this.game, "NIVEAU " + HappyKittensPuzzle.GameVars.currentLevel, true);
            ...
            var movesLabel = new Phaser.Text(_this.game, -340 / HappyKittensPuzzle.GameVars.stripesScale, 5, "COUPS:", { font: "40px Concert One", fill: "#FFFFFF" });
            _this.lowerStripe.add(movesLabel);
            _this.moves = new Phaser.Text(_this.game, -170 / HappyKittensPuzzle.GameVars.stripesScale, 5, HappyKittensPuzzle.GameVars.moves.toString(), { font: "40px Concert One", fill: "#FFFFFF" });
            ...
            if (levelBest > 0) {
                var bestLabel = new Phaser.Text(_this.game, -340 / HappyKittensPuzzle.GameVars.stripesScale, 50, "LEVEL'S BEST:", { font: "40px Concert One", fill: "#FFFFFF" });
                _this.lowerStripe.add(bestLabel);
                var best = new Phaser.Text(_this.game, -100 / HappyKittensPuzzle.GameVars.stripesScale, 50, levelBest.toString(), { font: "40px Concert One", fill: "#FFFFFF" });
        ...
        HUD.prototype.showGameFinishedMessage = function () {
            ...
            var congratulationsMessage = new Phaser.Text(this.game, HappyKittensPuzzle.GameConstants.GAME_WIDTH / 2, HappyKittensPuzzle.GameConstants.GAME_HEIGHT / 2, "MEOWW ! BRAVO !!! TOUS LES NIVEAUX SONT FRANCHIS !!!", { font: "76px Concert One", fill: "#FFFFFF" });
...
(function (HappyKittensPuzzle) {
    var PassedLevelKittenAnimation = (function (_super) {
        ...
        function PassedLevelKittenAnimation(game) {
            ...
            _this.kittenImage.scale.set(1.35);
...
(function (HappyKittensPuzzle) {
    var LevelSelectionState = (function (_super) {
        ...
        LevelSelectionState.prototype.create = function () {
            ...
            var logo = this.add.image(HappyKittensPuzzle.GameConstants.GAME_WIDTH / 2, HappyKittensPuzzle.GameConstants.GAME_HEIGHT - 55 * HappyKittensPuzzle.GameVars.scaleY, "texture_atlas_1", "logicieleducatif.png");
            logo.anchor.set(.5);
            logo.scale.set(1.25, 1.25 * HappyKittensPuzzle.GameVars.scaleY);
            var creditsLabel = this.add.text(HappyKittensPuzzle.GameConstants.GAME_WIDTH / 2, HappyKittensPuzzle.GameConstants.GAME_HEIGHT - 30 * HappyKittensPuzzle.GameVars.scaleY, "made by Ravalmatic, licensed to " + HappyKittensPuzzle.GameConstants.SPONSOR, { font: "23px Arial", fill: "#FFFFFF" });
...
(function (HappyKittensPuzzle) {
    var TitleContainer = (function (_super) {
        ...
        function TitleContainer(game) {
            ...
            colorStripe.scale.set(1.5 * HappyKittensPuzzle.GameConstants.GAME_WIDTH / 64, 12 / 64);
            yellowStripeContainer.add(colorStripe);
            var stripeLabel = new Phaser.Text(_this.game, 0, 18, "SELECTION DE NIVEAUX", { font: "70px Concert One", fill: "#FFFFFF" });
            stripeLabel.anchor.x = .5;
            stripeLabel.setShadow(4, 4, "rgba(197, 97, 0, 1)", 0);
