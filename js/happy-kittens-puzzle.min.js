            ...
            for (var col = 0; col < 5; col++) {
                ...
                for (var row = 0; row < 5; row++) {
                    if (HappyKittensPuzzle.GameConstants.EDITING_LEVELS) {
                        color = HappyKittensPuzzle.GameConstants.RED_SQUARE;
                    }
                    else {
                        color = HappyKittensPuzzle.GameVars.colors[col][row];
                    }
                    square = new HappyKittensPuzzle.Square(_this.game, color, col, row);
                    square.x = col * HappyKittensPuzzle.GameConstants.SQUARE_WIDTH - 2 * HappyKittensPuzzle.GameConstants.SQUARE_WIDTH;
                    square.y = row * HappyKittensPuzzle.GameConstants.SQUARE_WIDTH - 2 * HappyKittensPuzzle.GameConstants.SQUARE_WIDTH;
                    _this.add(square);
...
(function (HappyKittensPuzzle) {
    var BoardState = (function (_super) {
        ...
        BoardState.prototype.create = function () {
            var background = this.add.image(HappyKittensPuzzle.GameConstants.GAME_WIDTH / 2, HappyKittensPuzzle.GameConstants.GAME_HEIGHT / 2, "texture_atlas_1", "background.png");
...
(function (HappyKittensPuzzle) {
    var GUI = (function (_super) {
        ...
        function GUI(game) {
            ...
            var audioButton = new HappyKittensPuzzle.AudioButton(_this.game, 410, 25);
...
(function (HappyKittensPuzzle) {
    var HUD = (function (_super) {
        ...
        function HUD(game) {
            ...
            _this.levelLabel = new Phaser.Text(_this.game, HappyKittensPuzzle.GameConstants.GAME_WIDTH / 2, 20, "level " + HappyKittensPuzzle.GameVars.currentLevel, { font: "40px Arial", fill: "#000000" });
            _this.levelLabel.anchor.x = .5;
            _this.levelLabel.scale.y = HappyKittensPuzzle.GameVars.scaleY;
            _this.add(_this.levelLabel);
            _this.movements = new Phaser.Text(_this.game, 430, 530, "moves  " + HappyKittensPuzzle.GameVars.moves, { font: "30px Arial", fill: "#000000" });
            ...
            _this.movementsRecord = new Phaser.Text(_this.game, 430, 580, levelBestStr, { font: "30px Arial", fill: "#000000" });
...
(function (HappyKittensPuzzle) {
    var LevelManager = (function () {
        function LevelManager(game) {
            ...
            HappyKittensPuzzle.GameVars.colors = [];
            ...
            for (var col = 0; col < 8; col++) {
                HappyKittensPuzzle.GameVars.colors[col] = [];
                for (var row = 0; row < 8; row++) {
                    ...
                    if (r === 0xff && g === 0x00 && b === 0x00) {
                        HappyKittensPuzzle.GameVars.colors[col].push(HappyKittensPuzzle.GameConstants.RED_SQUARE);
                    }
                    if (r === 0xff && g === 0xff && b === 0xff) {
                        HappyKittensPuzzle.GameVars.colors[col].push(HappyKittensPuzzle.GameConstants.WHITE_SQUARE);
                    }
                }
            }
        }
        LevelManager.prototype.squareFlipped = function (column, row) {
            ...
            var squares = HappyKittensPuzzle.BoardState.currentInstance.board.squares;
            var c;
            var r;
        ...
        LevelManager.prototype.checkBoard = function () {
            ...
            for (var col = 0; col < 5 && passed; col++) {
                for (var row = 0; row < 5 && passed; row++) {
                    if (squares[col][row].color === HappyKittensPuzzle.GameConstants.WHITE_SQUARE) {
                        passed = false;
                    }
                }
            }
...
(function (HappyKittensPuzzle) {
    var Square = (function (_super) {
        ...
        function Square(game, color, column, row) {
            ...
            _this.column = column;
            _this.row = row;
            _this.square = new Phaser.Image(_this.game, 0, 0, "texture_atlas_1", "switch_on.png");
            _this.square.scale.set((HappyKittensPuzzle.GameConstants.SQUARE_WIDTH - 9) / 64);
            ...
            if (_this.color === HappyKittensPuzzle.GameConstants.WHITE_SQUARE) {
                _this.square.frameName = "switch_off.png";
            }
            return _this;
        }
        ...
        Square.prototype.flip = function () {
            ...
            this.color = this.color === HappyKittensPuzzle.GameConstants.RED_SQUARE ? HappyKittensPuzzle.GameConstants.WHITE_SQUARE : HappyKittensPuzzle.GameConstants.RED_SQUARE;
            this.square.frameName = this.color === HappyKittensPuzzle.GameConstants.WHITE_SQUARE ? "switch_on_off.png" : "switch_off_on.png";
        };
...
(function (HappyKittensPuzzle) {
    var LevelSelection = (function (_super) {
        ...
        LevelSelection.prototype.create = function () {
            var backgroundSprite = this.add.sprite(0, 0, this.game.cache.getBitmapData(HappyKittensPuzzle.GameConstants.WHITE_SQUARE));
            ...
            this.nextButton = this.add.button(420, HappyKittensPuzzle.GameConstants.GAME_HEIGHT / 2, "texture_atlas_1", this.onArrowClick, this);
            ...
            var audioButton = new HappyKittensPuzzle.AudioButton(this.game, 400, 35);
...
(function (HappyKittensPuzzle) {
    var LevelSelectionButton = (function (_super) {
        ...
        function LevelSelectionButton(game, level) {
            ...
            _this.buttonSprite = new Phaser.Sprite(_this.game, 0, 0, _this.game.cache.getBitmapData(HappyKittensPuzzle.GameConstants.RED_SQUARE));
        ...
        LevelSelectionButton.prototype.onOut = function () {
            this.buttonSprite.loadTexture(this.game.cache.getBitmapData(HappyKittensPuzzle.GameConstants.RED_SQUARE));
        };
...
(function (HappyKittensPuzzle) {
    var PreLoader = (function (_super) {
        ...
        PreLoader.prototype.generateBitmapData = function () {
            var bmd = this.game.add.bitmapData(64, 64, HappyKittensPuzzle.GameConstants.RED_SQUARE, true);
            bmd.ctx.beginPath();
...
(function (HappyKittensPuzzle) {
    var SplashState = (function (_super) {
        ...
        SplashState.prototype.create = function () {
            var backgroundSprite = this.add.sprite(0, 0, this.game.cache.getBitmapData(HappyKittensPuzzle.GameConstants.WHITE_SQUARE));
            backgroundSprite.scale.set(HappyKittensPuzzle.GameConstants.GAME_WIDTH / 64, HappyKittensPuzzle.GameConstants.GAME_HEIGHT / 64);
            var gameTitle = this.add.text(HappyKittensPuzzle.GameConstants.GAME_WIDTH / 2, 100, "Red Squares Out!", { font: "40px Arial", fill: "#FF1493" });
