...
(function (HappyKittensPuzzle) {
    var Boot = (function (_super) {
        ...
        Boot.enterIncorrectOrientation = function () {
            HappyKittensPuzzle.GameVars.wrongOrientation = true;
        };
        ...
        Boot.prototype.init = function () {
            ...
            if (!HappyKittensPuzzle.GameConstants.DEVELOPMENT) {
                ...
                window.cacheAds = function () {
                    VMAX.jioSDK_adId = "happy-kittens";
...
(function (HappyKittensPuzzle) {
    var InstructionsLayer = (function (_super) {
        ...
        function InstructionsLayer(game, inTutorial) {
            ...
            var instructionsStr = "MEOW! use the keys 1, 2, 3, 4 to select the kitty, blah, blah, blah...";
            var instructionsLabel = new Phaser.Text(_this.game, HappyKittensPuzzle.GameConstants.GAME_WIDTH / 2, 120, instructionsStr, { font: "28px Concert One", fill: "#FFFFFF" });
            ...
            var button = new Phaser.Button(_this.game, HappyKittensPuzzle.GameConstants.GAME_WIDTH / 2, 280, "texture_atlas_1", _this.removeInstructions, _this);
            button.setFrames("button-level-selection-on-on.png", "button-level-selection-on-off.png", "button-level-selection-on-on.png");
            button.anchor.set(.5);
            _this.add(button);
            return _this;
        }
        InstructionsLayer.prototype.removeInstructions = function (b) {
            b.clearFrames();
            if (this.inTutorial) {
            ...
            for (var col = 0; col < 3; col++) {
                for (var row = 0; row < 4; row++) {
                    ...
                    if (level <= HappyKittensPuzzle.GameVars.achievedLevel) {
                        ...
                        if (col < 2) {
                            if ((level + 1) <= HappyKittensPuzzle.GameVars.achievedLevel) {
