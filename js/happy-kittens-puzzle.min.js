...
(function (HappyKittensPuzzle) {
    var AudioButton = (function (_super) {
        ...
        function AudioButton(game, x, y) {
            ...
            _this.button = new Phaser.Button(_this.game, x, y, "texture_atlas_1", _this.onClick, _this);
            _this.button.name = "audio";
            ...
            var mark = new Phaser.Image(_this.game, -5, -5, "texture_atlas_1", "button-audio-mark.png");
            mark.visible = false;
            _this.button.addChild(mark);
            return _this;
        }
        AudioButton.prototype.onClick = function (b) {
            b.clearFrames();
            if (HappyKittensPuzzle.AudioManager.getInstance().isMuted) {
...
(function (HappyKittensPuzzle) {
    var Boot = (function (_super) {
        ...
        Boot.prototype.init = function () {
            ...
            HappyKittensPuzzle.GameVars.upperStripe_py = 6.25;
            HappyKittensPuzzle.GameVars.lowerStripe_py = 281.25;
        ...
        Boot.prototype.initJIO = function () {
            ...
            if (!HappyKittensPuzzle.GameConstants.DEVELOPMENT) {
                ...
                HappyKittensPuzzle.GameVars.wrongOrientation = userAgent.indexOf("F300B") !== -1;
                var id = HappyKittensPuzzle.GameVars.wrongOrientation ? "happy-kittens-2" : "happy-kittens";
...
(function (HappyKittensPuzzle) {
    var GameConstants = (function () {
        ...
        GameConstants.GAME_WIDTH = 240;
        GameConstants.GAME_HEIGHT = 320;
        ...
        GameConstants.SQUARE_WIDTH = 42;
        GameConstants.TIME_FADE = 350;
        GameConstants.TOTAL_LEVELS = 60;
        GameConstants.LEVEL_BEST_KEY = "hk-levels-best-results";
        GameConstants.SCORE_KEY = "hk-score";
        GameConstants.AUDIO_STATE_KEY = "hk-audio";
...
(function (HappyKittensPuzzle) {
    var GameManager = (function () {
        ...
        GameManager.init = function (game) {
            ...
            HappyKittensPuzzle.GameVars.congratulationsMessageShown = false;
        };
        ...
        GameManager.levelPassed = function () {
            ...
            if (HappyKittensPuzzle.GameVars.currentLevel < HappyKittensPuzzle.GameConstants.TOTAL_LEVELS) {
                ...
                HappyKittensPuzzle.GameVars.gameFinished = true;
                HappyKittensPuzzle.GameVars.achievedLevel = HappyKittensPuzzle.GameConstants.TOTAL_LEVELS;
            }
            HappyKittensPuzzle.GameVars.setLocalStorageData(HappyKittensPuzzle.GameConstants.LEVEL_BEST_KEY, JSON.stringify(HappyKittensPuzzle.GameVars.levelsBestResults));
        };
        GameManager.congratulationsMessageShown = function () {
            HappyKittensPuzzle.GameVars.congratulationsMessageShown = true;
        };
...
(function (HappyKittensPuzzle) {
    var NavigationManager = (function () {
        function NavigationManager(game) {
            this.game = game;
        ...
        NavigationManager.prototype.resetComponents = function () {
        ...
        NavigationManager.prototype.setDefaultComponent = function (button) {
            if (this.components[this.currentComponentPosition]) {
        ...
        NavigationManager.prototype.addComponent = function (button, parent) {
            var component = { button: button, parent: parent };
            this.components.push(component);
        };
        NavigationManager.prototype.setLeftComponent = function (buttonName, newtButtonName) {
            for (var i = 0; i < this.components.length; i++) {
        ...
        NavigationManager.prototype.setRightComponent = function (buttonName, newtButtonName) {
            for (var i = 0; i < this.components.length; i++) {
                if (this.components[i].button.name === buttonName) {
        ...
        NavigationManager.prototype.setUpComponent = function (buttonName, newtButtonName) {
            for (var i = 0; i < this.components.length; i++) {
                if (this.components[i].button.name === buttonName) {
        ...
        NavigationManager.prototype.setDownComponent = function (buttonName, newtButtonName) {
            for (var i = 0; i < this.components.length; i++) {
                if (this.components[i].button.name === buttonName) {
        ...
        NavigationManager.prototype.update = function () {
            if (this.enterKey.justDown || this.fiveKey.justDown) {
                if (HappyKittensPuzzle.GameVars.paused) {
                    return;
                }
                if (HappyKittensPuzzle.BoardState.currentInstance && HappyKittensPuzzle.BoardState.currentInstance.instructionsLayer) {
                    HappyKittensPuzzle.BoardState.currentInstance.instructionsLayer.removeInstructions();
                    return;
                }
                var currentComponent = this.components[this.currentComponentPosition];
                currentComponent.parent.onClick(currentComponent.button);
            }
            if (this.zeroKey.justDown && HappyKittensPuzzle.BoardState.currentInstance && !HappyKittensPuzzle.BoardState.currentInstance.instructionsLayer) {
                if (HappyKittensPuzzle.GameVars.paused) {
                    HappyKittensPuzzle.BoardManager.resumeGame();
                }
                else {
                    HappyKittensPuzzle.BoardManager.pauseGame();
                }
            }
            if (HappyKittensPuzzle.GameVars.wrongOrientation) {
                if (HappyKittensPuzzle.GameVars.paused) {
                    return;
                }
        ...
        NavigationManager.prototype.justRight = function () {
            var currentComponent = this.components[this.currentComponentPosition];
        ...
        NavigationManager.prototype.justUp = function () {
            var currentComponent = this.components[this.currentComponentPosition];
        ...
        NavigationManager.prototype.justDown = function () {
            var currentComponent = this.components[this.currentComponentPosition];
    ...
    HappyKittensPuzzle.NavigationManager = NavigationManager;
})(HappyKittensPuzzle || (HappyKittensPuzzle = {}));
var HappyKittensPuzzle;
(function (HappyKittensPuzzle) {
    var PreLoader = (function (_super) {
        ...
        PreLoader.prototype.composeScene = function () {
            ...
            var gameLogo = this.add.image(HappyKittensPuzzle.GameConstants.GAME_WIDTH / 2, 60, "game-title");
            gameLogo.anchor.set(.5);
            gameLogo.scale.y = HappyKittensPuzzle.GameVars.scaleY;
            this.loadingLabel = this.add.text(HappyKittensPuzzle.GameConstants.GAME_WIDTH / 2, 148, "loading...", { font: "20px Concert One", fill: "#FFFFFF" });
            ...
            var preloadBarCapsuleShadow = new Phaser.Sprite(this.game, HappyKittensPuzzle.GameConstants.GAME_WIDTH / 2 + 1.56, 1.25, this.game.cache.getBitmapData(HappyKittensPuzzle.GameConstants.BLACK_SQUARE));
            ...
            this.preloadBar = new Phaser.Sprite(this.game, HappyKittensPuzzle.GameConstants.GAME_WIDTH / 2 - 98.4, 0, this.game.cache.getBitmapData(HappyKittensPuzzle.GameConstants.ORANGE_SQUARE));
...
(function (HappyKittensPuzzle) {
    var YellowStripe = (function (_super) {
        ...
        function YellowStripe(game, text) {
            ...
            colorStripe.scale.set(1.5 * HappyKittensPuzzle.GameConstants.GAME_WIDTH / 64, 3.75 / 64);
            ...
            colorStripe.anchor.x = .5;
            colorStripe.scale.set(1.5 * HappyKittensPuzzle.GameConstants.GAME_WIDTH / 64, 28.125 / 64);
            _this.add(colorStripe);
            ...
            colorStripe.anchor.x = .5;
            colorStripe.scale.set(1.5 * HappyKittensPuzzle.GameConstants.GAME_WIDTH / 64, 5 / 64);
            colorStripe.alpha = .45;
            _this.add(colorStripe);
            var stripeLabel = new Phaser.Text(_this.game, 0, 5.625, text, { font: "22px Concert One", fill: "#FFFFFF" });
...
(function (HappyKittensPuzzle) {
    var Board = (function (_super) {
        ...
        function Board(game, navManager) {
            var _this = _super.call(this, game, null, "board") || this;
            _this.navManager = navManager;
        ...
        Board.prototype.setNavComponents = function () {
            for (var col = 0; col < 5; col++) {
                for (var row = 0; row < 5; row++) {
...
(function (HappyKittensPuzzle) {
    var BoardManager = (function () {
        ...
        BoardManager.init = function (game) {
            ...
            var bmd = new Phaser.BitmapData(BoardManager.game, "tmp-bitmapdata", 5, 5);
            var levelImage = new Phaser.Image(BoardManager.game, 0, 0, "texture_atlas_1", "level-" + HappyKittensPuzzle.GameVars.currentLevel + ".png");
        ...
        BoardManager.pauseGame = function () {
            HappyKittensPuzzle.GameVars.paused = true;
            HappyKittensPuzzle.BoardState.currentInstance.pauseGame();
        };
        BoardManager.resumeGame = function () {
            HappyKittensPuzzle.GameVars.paused = false;
            HappyKittensPuzzle.BoardState.currentInstance.resumeGame();
        };
        ...
        BoardManager.update = function () {
            ...
            if (BoardManager.frameCounterSleep > 600 && !HappyKittensPuzzle.GameVars.levelPassed) {
                BoardManager.frameCounterSleep = 0;
                var board = HappyKittensPuzzle.BoardState.currentInstance.board;
                board.makeOneKittenSleep();
            }
        };
        BoardManager.cellOver = function (column, row) {
        ...
        BoardManager.cellOut = function (column, row) {
            var c;
            var r;
            var cells = HappyKittensPuzzle.BoardState.currentInstance.board.cells;
            for (var i = 0; i < BoardManager.neighbourSquares.length; i++) {
        ...
        BoardManager.cellFlipped = function (col, row) {
            BoardManager.frameCounterSleep = 0;
            var board = HappyKittensPuzzle.BoardState.currentInstance.board;
            ...
            BoardManager.game.time.events.add(275, function (args) {
                var cells = args[0];
        ...
        BoardManager.checkBoard = function () {
            var passed = true;
            var cells = HappyKittensPuzzle.BoardState.currentInstance.board.cells;
...
(function (HappyKittensPuzzle) {
    var BoardState = (function (_super) {
        ...
        BoardState.prototype.init = function () {
            ...
            HappyKittensPuzzle.BoardManager.init(this.game);
            this.navManager = new HappyKittensPuzzle.NavigationManager(this.game);
        };
        BoardState.prototype.create = function () {
            ...
            this.board = new HappyKittensPuzzle.Board(this.game, this.navManager);
            ...
            if (HappyKittensPuzzle.GameVars.currentLevel === 1 && HappyKittensPuzzle.GameVars.levelsBestResults[0] === 0) {
                this.instructionsLayer = new HappyKittensPuzzle.InstructionsLayer(this.game, true);
                this.add.existing(this.instructionsLayer);
            }
            else {
                this.instructionsLayer = null;
            }
            if (HappyKittensPuzzle.GameVars.currentLevel < 4 && HappyKittensPuzzle.GameVars.levelsBestResults[HappyKittensPuzzle.GameVars.currentLevel - 1] === 0 && !this.instructionsLayer) {
        ...
        BoardState.prototype.update = function () {
            ...
            HappyKittensPuzzle.BoardManager.update();
            this.navManager.update();
        };
        BoardState.prototype.setNavComponents = function () {
        ...
        BoardState.prototype.pauseGame = function () {
            this.pauseLayer = new HappyKittensPuzzle.PauseLayer(this.game);
            this.add.existing(this.pauseLayer);
        };
        BoardState.prototype.resumeGame = function () {
        ...
        BoardState.prototype.levelEnded = function () {
            ...
            if (HappyKittensPuzzle.GameVars.currentLevel === 60 && HappyKittensPuzzle.GameVars.congratulationsMessageShown) {
                return;
            }
            if (HappyKittensPuzzle.GameVars.gameFinished && HappyKittensPuzzle.GameVars.currentLevel === 60) {
        ...
        BoardState.funoStartWithoutAudio = false;
        return BoardState;
    }(Phaser.State));
...
(function (HappyKittensPuzzle) {
    var Cell = (function (_super) {
        ...
        function Cell(game, state, column, row) {
            var _this = _super.call(this, game, null, "cell", false) || this;
            _this.state = state;
            _this.column = column;
            _this.row = row;
            ...
            _this.mark = new Phaser.Image(_this.game, 0, 0, "texture_atlas_1", "cat-mark.png");
            _this.mark.anchor.set(.5);
            _this.mark.visible = false;
            _this.addAt(_this.mark, 0);
        ...
        Cell.prototype.onClick = function () {
            ...
            if (HappyKittensPuzzle.GameConstants.EDITING_LEVELS) {
                ...
                HappyKittensPuzzle.BoardManager.cellFlipped(this.column, this.row);
            }
        ...
        Cell.prototype.onOver = function () {
            ...
            if (!HappyKittensPuzzle.GameConstants.EDITING_LEVELS) {
                HappyKittensPuzzle.BoardManager.cellOver(this.column, this.row);
            }
        ...
        Cell.prototype.onOut = function () {
            ...
            if (!HappyKittensPuzzle.GameConstants.EDITING_LEVELS) {
                HappyKittensPuzzle.BoardManager.cellOut(this.column, this.row);
            }
        };
        Cell.FLIP_TIME = 175;
...
(function (HappyKittensPuzzle) {
    var GUI = (function (_super) {
        ...
        function GUI(game) {
            ...
            _this.audioButton = new HappyKittensPuzzle.AudioButton(_this.game, HappyKittensPuzzle.AudioButton.PX / HappyKittensPuzzle.GameVars.stripesScale, HappyKittensPuzzle.AudioButton.PY);
            var yellowStripe = HappyKittensPuzzle.BoardState.currentInstance.hud.yellowStripe;
            yellowStripe.add(_this.audioButton);
            var lowerStripe = HappyKittensPuzzle.BoardState.currentInstance.hud.lowerStripe;
            _this.exitButton = new Phaser.Button(_this.game, 50 / HappyKittensPuzzle.GameVars.stripesScale, 5, "texture_atlas_1", _this.onClick, _this);
            _this.exitButton.setFrames("button-exit-on.png", "button-exit-off.png", "button-exit-on.png", "button-exit-off.png");
            _this.exitButton.name = "exit";
            lowerStripe.add(_this.exitButton);
            var mark = new Phaser.Image(_this.game, -5, -5, "texture_atlas_1", "button-audio-mark.png");
            mark.visible = false;
            _this.exitButton.addChild(mark);
            _this.resetButton = new Phaser.Button(_this.game, 84.375 / HappyKittensPuzzle.GameVars.stripesScale, 5, "texture_atlas_1", _this.onClick, _this);
            _this.resetButton.setFrames("button-reset-on.png", "button-reset-off.png", "button-reset-on.png", "button-reset-off.png");
            _this.resetButton.name = "reset";
            lowerStripe.add(_this.resetButton);
            mark = new Phaser.Image(_this.game, -5, -5, "texture_atlas_1", "button-audio-mark.png");
            mark.visible = false;
            _this.resetButton.addChild(mark);
            return _this;
        }
        GUI.prototype.onClick = function (b) {
            if (b.name === "exit") {
                HappyKittensPuzzle.BoardManager.exit();
            }
            else {
                HappyKittensPuzzle.BoardManager.resetLevel();
            }
...
(function (HappyKittensPuzzle) {
    var HUD = (function (_super) {
        ...
        function HUD(game) {
            ...
            stripeBackground.scale.set(1.5 * HappyKittensPuzzle.GameConstants.GAME_WIDTH / 64, 31.25 / 64);
            stripeBackground.anchor.x = .5;
            stripeBackground.alpha = .5;
            _this.lowerStripe.add(stripeBackground);
            var movesLabel = new Phaser.Text(_this.game, -106.25 / HappyKittensPuzzle.GameVars.stripesScale, 1.56, "MOVES:", { font: "12.5px Concert One", fill: "#FFFFFF" });
            _this.lowerStripe.add(movesLabel);
            _this.moves = new Phaser.Text(_this.game, -53.125 / HappyKittensPuzzle.GameVars.stripesScale, 1.56, HappyKittensPuzzle.GameVars.moves.toString(), { font: "12.5px Concert One", fill: "#FFFFFF" });
            ...
            if (levelBest > 0) {
                var bestLabel = new Phaser.Text(_this.game, -106.25 / HappyKittensPuzzle.GameVars.stripesScale, 15.625, "LEVEL'S BEST:", { font: "12.5px Concert One", fill: "#FFFFFF" });
                _this.lowerStripe.add(bestLabel);
                var best = new Phaser.Text(_this.game, -31.25 / HappyKittensPuzzle.GameVars.stripesScale, 15.625, levelBest.toString(), { font: "12.5px Concert One", fill: "#FFFFFF" });
        ...
        HUD.prototype.showGameFinishedMessage = function () {
            HappyKittensPuzzle.GameManager.congratulationsMessageShown();
            ...
            backgroundSprite.scale.set(HappyKittensPuzzle.GameConstants.GAME_WIDTH / 64, 110 / 64);
            var congratulationsMessage = new Phaser.Text(this.game, HappyKittensPuzzle.GameConstants.GAME_WIDTH / 2, HappyKittensPuzzle.GameConstants.GAME_HEIGHT / 2, "MEOW! CONGRATULATIONS ALL LEVELS CLEARED", { font: "23.75px Concert One", fill: "#FFFFFF" });
...
(function (HappyKittensPuzzle) {
    var HandIcon = (function (_super) {
        ...
        function HandIcon(game, x, y) {
            var _this = _super.call(this, game, x + 4.5, y + 4.5 * HappyKittensPuzzle.GameVars.scaleY, "texture_atlas_1", "finger_cursor.png") || this;
...
var HappyKittensPuzzle;
(function (HappyKittensPuzzle) {
    var InstructionsLayer = (function (_super) {
        __extends(InstructionsLayer, _super);
        function InstructionsLayer(game, inTutorial) {
            var _this = _super.call(this, game, null, "instructions") || this;
            _this.inTutorial = inTutorial || false;
            var background = new Phaser.Sprite(_this.game, 0, 0, _this.game.cache.getBitmapData(HappyKittensPuzzle.GameConstants.BLACK_SQUARE));
            ...
            var instructionsStr = "MEOW! Use direction pad or numbers 2(up), 8(down), 4(left), 6(right) to move and press enter to select the kitty.";
            var instructionsLabel = new Phaser.Text(_this.game, HappyKittensPuzzle.GameConstants.GAME_WIDTH / 2, 120, instructionsStr, { font: "22px Concert One", fill: "#FFFFFF" });
            ...
            _this.add(instructionsLabel);
            var removeLabel = new Phaser.Text(_this.game, HappyKittensPuzzle.GameConstants.GAME_WIDTH / 2, HappyKittensPuzzle.GameConstants.GAME_HEIGHT - 40, "Press Enter to start playing", { font: "18px Concert One", fill: "#FF0000" });
            removeLabel.anchor.set(.5, 1);
            removeLabel.setShadow(1.25, 1.25, "rgba(0, 0, 0, 1)", 0);
            _this.add(removeLabel);
            _this.game.add.tween(removeLabel)
                .to({ alpha: 0 }, 1000, Phaser.Easing.Cubic.In, true, 0, -1, true);
            return _this;
        }
        InstructionsLayer.prototype.removeInstructions = function () {
            if (this.inTutorial) {
                HappyKittensPuzzle.BoardState.currentInstance.instructionsLayer = null;
                HappyKittensPuzzle.BoardState.currentInstance.activateTutorial();
            }
            this.destroy();
        };
        return InstructionsLayer;
    }(Phaser.Group));
    HappyKittensPuzzle.InstructionsLayer = InstructionsLayer;
})(HappyKittensPuzzle || (HappyKittensPuzzle = {}));
var HappyKittensPuzzle;
(function (HappyKittensPuzzle) {
...
(function (HappyKittensPuzzle) {
    var PauseLayer = (function (_super) {
        ...
        function PauseLayer(game) {
            var _this = _super.call(this, game, null, "pause") || this;
            var background = new Phaser.Sprite(_this.game, 0, 0, _this.game.cache.getBitmapData(HappyKittensPuzzle.GameConstants.BLACK_SQUARE));
            background.scale.set(HappyKittensPuzzle.GameConstants.GAME_WIDTH / 64, HappyKittensPuzzle.GameConstants.GAME_HEIGHT / 64);
            background.alpha = .85;
            background.inputEnabled = true;
            ...
            _this.add(background);
            var pauseLabel = new Phaser.Text(_this.game, HappyKittensPuzzle.GameConstants.GAME_WIDTH / 2, 120, "GAME PAUSED", { font: "32px Concert One", fill: "#FFFFFF", align: "center" });
            pauseLabel.anchor.set(.5);
            pauseLabel.setShadow(2, 2, "rgba(0, 0, 0, 1)", 0);
            _this.add(pauseLabel);
            return _this;
        }
        return PauseLayer;
    }(Phaser.Group));
    HappyKittensPuzzle.PauseLayer = PauseLayer;
})(HappyKittensPuzzle || (HappyKittensPuzzle = {}));
var HappyKittensPuzzle;
(function (HappyKittensPuzzle) {
    var LevelSelectionButton = (function (_super) {
        ...
        function LevelSelectionButton(game, level) {
            ...
            _this.button = new Phaser.Button(_this.game, 0, 0, "texture_atlas_1", _this.onClick, _this);
            _this.button.setFrames("button-level-selection-on-on.png", "button-level-selection-on-off.png", "button-level-selection-on-on.png");
            _this.button.anchor.set(.5);
            _this.button.name = level.toString();
            _this.add(_this.button);
            if (isBlocked) {
                _this.button.setFrames("button-level-selection-blocked.png", "button-level-selection-blocked.png", "button-level-selection-blocked.png");
                _this.button.inputEnabled = false;
            }
            else {
                var mark = new Phaser.Image(_this.game, 0, 0, "texture_atlas_1", "button-level-selection-mark.png");
                mark.anchor.set(.5);
                mark.visible = false;
                _this.button.addChild(mark);
            }
            var levelLabel = new Phaser.Text(_this.game, 0, -2.2, _this.level.toString(), { font: "19px Concert One", fill: "#FFFFFF" });
...
(function (HappyKittensPuzzle) {
    var LevelSelectionState = (function (_super) {
        ...
        LevelSelectionState.prototype.create = function () {
            ...
            this.audioButton = new HappyKittensPuzzle.AudioButton(this.game, HappyKittensPuzzle.GameConstants.GAME_WIDTH - 27, 4);
            this.audioButton.scale.y = HappyKittensPuzzle.GameVars.scaleY;
            this.add.existing(this.audioButton);
            this.levelsRail = new Phaser.Group(this.game);
            this.add.existing(this.levelsRail);
            var levelsContainer_py = 205;
            var levelsContainerScale = 1;
            this.levelsContainers = [];
            var levelsContainer;
            for (var i = 0; i < LevelSelectionState.LEVEL_PAGES; i++) {
                levelsContainer = new HappyKittensPuzzle.LevelsContainer(this.game, i, this.navManager);
                levelsContainer.x = HappyKittensPuzzle.GameConstants.GAME_WIDTH * (.5 + i);
                levelsContainer.y = levelsContainer_py;
                levelsContainer.scale.setTo(levelsContainerScale, HappyKittensPuzzle.GameVars.scaleY);
            ...
            var mark = this.add.image(0, 0, "texture_atlas_1", "button-next-mark.png");
            mark.anchor.set(.5);
            mark.visible = false;
        ...
        LevelSelectionState.prototype.update = function () {
            this.navManager.update();
        };
        ...
        LevelSelectionState.prototype.setNavComponents = function (defaultButton) {
            var first = true;
            if (defaultButton) {
                first = false;
            }
            ...
            if (HappyKittensPuzzle.GameVars.achievedLevel >= (this.indexLevelsPage * 12 + 1)) {
            ...
            if (HappyKittensPuzzle.GameVars.achievedLevel >= (this.indexLevelsPage * 12 + 1) && HappyKittensPuzzle.GameVars.achievedLevel <= (this.indexLevelsPage + 1) * 12) {
                this.navManager.setLeftComponent(LevelSelectionState.NEXT, HappyKittensPuzzle.GameVars.achievedLevel.toString());
            }
            else if (HappyKittensPuzzle.GameVars.achievedLevel > (this.indexLevelsPage + 1) * 12) {
            ...
            if (HappyKittensPuzzle.GameVars.achievedLevel >= (this.indexLevelsPage * 12 + 1) && HappyKittensPuzzle.GameVars.achievedLevel <= (this.indexLevelsPage + 1) * 12) {
                this.navManager.setRightComponent(LevelSelectionState.PREVIOUS, HappyKittensPuzzle.GameVars.achievedLevel.toString());
            }
            else if (HappyKittensPuzzle.GameVars.achievedLevel > (this.indexLevelsPage + 1) * 12) {
        ...
        LevelSelectionState.prototype.onClick = function (b) {
            b.clearFrames();
        ...
        LevelSelectionState.prototype.setCurrentLevelPage = function () {
            this.indexLevelsPage = Math.floor((HappyKittensPuzzle.GameVars.currentLevel - 1) / 12);
            if (this.indexLevelsPage === 0) {
                this.previousButton.visible = false;
            }
...
(function (HappyKittensPuzzle) {
    var LevelsContainer = (function (_super) {
        ...
        function LevelsContainer(game, i, navManager) {
            var _this = _super.call(this, game, null, "level-container") || this;
            _this.i = i;
            _this.scale.y = HappyKittensPuzzle.GameVars.scaleY;
            _this.navManager = navManager;
            _this.levelSelectionButtons = [];
            var levelSelectionButton;
            for (var col = 0; col < 3; col++) {
                _this.levelSelectionButtons[col] = [];
                for (var row = 0; row < 4; row++) {
                    var level = _this.i * 12 + (col + 1) + 3 * row;
                    levelSelectionButton = new HappyKittensPuzzle.LevelSelectionButton(_this.game, level);
                    levelSelectionButton.x = -43.75 * (1 - col);
                    levelSelectionButton.y = -43.75 * (1.5 - row);
                    _this.add(levelSelectionButton);
                    _this.levelSelectionButtons[col].push(levelSelectionButton);
                }
            }
            return _this;
        }
        LevelsContainer.prototype.setNavComponents = function (first) {
            for (var col = 0; col < 3; col++) {
                for (var row = 0; row < 4; row++) {
                    var level = this.i * 12 + (col + 1) + 3 * row;
                    if (level <= HappyKittensPuzzle.GameVars.achievedLevel) {
                        ...
                        if (level % 12 !== 1) {
                            ...
                            this.navManager.setLeftComponent(level.toString(), HappyKittensPuzzle.LevelSelectionState.PREVIOUS);
                        }
                        if ((level + 1) <= HappyKittensPuzzle.GameVars.achievedLevel && level % 12 !== 0) {
                            this.navManager.setRightComponent(level.toString(), (level + 1).toString());
                        }
                        else {
                            this.navManager.setRightComponent(level.toString(), HappyKittensPuzzle.LevelSelectionState.NEXT);
                        }
                        if (row > 0) {
                        ...
                        if (row < 3 && (level + 3) <= HappyKittensPuzzle.GameVars.achievedLevel) {
...
(function (HappyKittensPuzzle) {
    var TitleContainer = (function (_super) {
        ...
        function TitleContainer(game) {
            ...
            var shadowHeight = 98;
            var yellowStripeContainer_py = 60;
            ...
            shadow.alpha = .45;
            _this.add(shadow);
            var gameTitle = new Phaser.Image(_this.game, -4, -4, "texture_atlas_1", "title_bar.png");
            ...
            var colorStripe = new Phaser.Sprite(_this.game, 0, 0, _this.game.cache.getBitmapData(HappyKittensPuzzle.GameConstants.YELLOW_SQUARE));
            colorStripe.anchor.x = .5;
            colorStripe.scale.set(1.5 * HappyKittensPuzzle.GameConstants.GAME_WIDTH / 64, 4 / 64);
            yellowStripeContainer.add(colorStripe);
            colorStripe = new Phaser.Sprite(_this.game, 0, colorStripe.y + colorStripe.height, _this.game.cache.getBitmapData(HappyKittensPuzzle.GameConstants.ORANGE_SQUARE));
            colorStripe.anchor.x = .5;
            colorStripe.scale.set(1.5 * HappyKittensPuzzle.GameConstants.GAME_WIDTH / 64, 28 / 64);
            yellowStripeContainer.add(colorStripe);
            colorStripe = new Phaser.Sprite(_this.game, 0, colorStripe.y + colorStripe.height, _this.game.cache.getBitmapData(HappyKittensPuzzle.GameConstants.YELLOW_SQUARE));
            colorStripe.anchor.x = .5;
            colorStripe.scale.set(1.5 * HappyKittensPuzzle.GameConstants.GAME_WIDTH / 64, 4 / 64);
            yellowStripeContainer.add(colorStripe);
            var stripeLabel = new Phaser.Text(_this.game, 0, 6, "SELECT LEVEL", { font: "22px Concert One", fill: "#FFFFFF" });
            stripeLabel.anchor.x = .5;
            stripeLabel.setShadow(1.25, 1.25, "rgba(197, 97, 0, 1)", 0);
