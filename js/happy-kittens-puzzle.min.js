    ...
    var BoardManager = (function () {
        ...
        BoardManager.cellFlipped = function (col, row) {
            ...
            BoardManager.game.time.events.add(275, function (args) {
                ...
                var levelPassed = BoardManager.checkBoard();
                if (levelPassed) {
                    BoardManager.levelPassed();
                }
            }, BoardManager, [cellsToFlip, flipOrientation]);
            ...
            if (HappyKittensPuzzle.GameConstants.SPONSOR === HappyKittensPuzzle.GameConstants.COOLGAMES && BoardManager.timerEvent === null) {
                ...
                BoardManager.timerEvent = BoardManager.game.time.events.loop(Phaser.Timer.SECOND, BoardManager.onSecondPassed, BoardManager);
            }
