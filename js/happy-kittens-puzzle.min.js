...
(function (HappyKittensPuzzle) {
    var AudioButton = (function (_super) {
        ...
        function AudioButton(game, x, y) {
            ...
            var mark = new Phaser.Image(_this.game, 0, 0, "texture_atlas_1", "button-audio-mark.png");
            mark.visible = false;
...
(function (HappyKittensPuzzle) {
    var GameManager = (function () {
        ...
        GameManager.init = function (game) {
            ...
            HappyKittensPuzzle.GameVars.currentLevel = 20;
...
(function (HappyKittensPuzzle) {
    var GUI = (function (_super) {
        ...
        function GUI(game) {
            ...
            _this.exitButton = new Phaser.Button(_this.game, 60 / HappyKittensPuzzle.GameVars.stripesScale, 5, "texture_atlas_1", _this.onClick, _this);
            ...
            mark = new Phaser.Image(_this.game, 0, 0, "texture_atlas_1", "button-audio-mark.png");
            mark.visible = false;
