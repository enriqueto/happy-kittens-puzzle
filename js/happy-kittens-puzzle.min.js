...
(function (HappyKittensPuzzle) {
    var GUI = (function (_super) {
        ...
        function GUI(game) {
            ...
            _this.exitButton = new Phaser.Button(_this.game, 190 / HappyKittensPuzzle.GameVars.stripesScale, 16, "texture_atlas_1", _this.onExitClicked, _this);
            _this.exitButton.setFrames("button-exit-on.png", "button-exit-off.png", "button-exit-on.png");
            lowerStripe.add(_this.exitButton);
            _this.resetButton = new Phaser.Button(_this.game, 270 / HappyKittensPuzzle.GameVars.stripesScale, 16, "texture_atlas_1", _this.onResetClicked, _this);
