...
(function (HappyKittensPuzzle) {
    var Cell = (function (_super) {
        ...
        function Cell(game, color, column, row) {
            var _this = _super.call(this, game, null, "cards", false) || this;
            _this.color = color;
            _this.column = column;
            _this.row = row;
            _this.canBeFlipped = true;
        ...
        Cell.prototype.unflip = function () {
...
(function (HappyKittensPuzzle) {
    var GUI = (function (_super) {
        ...
        function GUI(game) {
            ...
            _this.exitButton = new Phaser.Button(_this.game, 100, 900, "texture_atlas_1", _this.onExitClicked, _this);
...
(function (HappyKittensPuzzle) {
    var HUD = (function (_super) {
        ...
        function HUD(game) {
            ...
            _this.levelLabel = new Phaser.Text(_this.game, HappyKittensPuzzle.GameConstants.GAME_WIDTH / 2, 20, "level " + HappyKittensPuzzle.GameVars.currentLevel, { font: "80px Arial", fill: "#000000" });
            _this.levelLabel.anchor.x = .5;
            _this.levelLabel.scale.y = HappyKittensPuzzle.GameVars.scaleY;
            _this.add(_this.levelLabel);
            _this.movements = new Phaser.Text(_this.game, 430, 880, "moves  " + HappyKittensPuzzle.GameVars.moves, { font: "30px Arial", fill: "#000000" });
            ...
            _this.movementsRecord = new Phaser.Text(_this.game, 430, 950, levelBestStr, { font: "30px Arial", fill: "#000000" });
...
(function (HappyKittensPuzzle) {
    var LevelManager = (function () {
        ...
        LevelManager.prototype.squareFlipped = function (column, row) {
            ...
            var squares = HappyKittensPuzzle.BoardState.currentInstance.board.cells;
            var c;
            var r;
        ...
        LevelManager.prototype.checkBoard = function () {
            ...
            for (var col = 0; col < 5 && passed; col++) {
                for (var row = 0; row < 5 && passed; row++) {
                    if (squares[col][row].color === HappyKittensPuzzle.GameConstants.GRUMPY) {
                        passed = false;
                    }
                }
            }
...
(function (HappyKittensPuzzle) {
    ...
    GameConstants.HAPPY = "happy";
    GameConstants.GRUMPY = "grumpy";
