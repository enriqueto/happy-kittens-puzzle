...
(function (HappyKittensPuzzle) {
    var PassedLevelKittenAnimation = (function (_super) {
        ...
        function PassedLevelKittenAnimation(game) {
            ...
            _this.kittenImage = new Phaser.Image(_this.game, -100, HappyKittensPuzzle.GameConstants.GAME_HEIGHT / 2, "texture_atlas_1", kittenTextureName);
            _this.kittenImage.scale.set(1.15, 1.15 * HappyKittensPuzzle.GameVars.scaleY);
            _this.kittenImage.anchor.set(.5);
            _this.add(_this.kittenImage);
            return _this;
        }
        PassedLevelKittenAnimation.prototype.activate = function () {
            this.game.add.tween(this.kittenImage)
                .to({ angle: 360, x: HappyKittensPuzzle.GameConstants.GAME_WIDTH + 100 }, 850, Phaser.Easing.Linear.None, true, 150);
        };
