...
(function (HappyKittensPuzzle) {
    var HUD = (function (_super) {
        ...
        function HUD(game) {
            ...
            _this.yellowStripe = new HappyKittensPuzzle.YellowStripe(_this.game, "NIVEAU " + HappyKittensPuzzle.GameVars.currentLevel);
...
(function (HappyKittensPuzzle) {
    var LevelSelectionState = (function (_super) {
        ...
        LevelSelectionState.prototype.create = function () {
            ...
            else if (HappyKittensPuzzle.GameConstants.SPONSOR !== HappyKittensPuzzle.GameConstants.FUNO) {
