...
(function (HappyKittensPuzzle) {
    var Game = (function (_super) {
        ...
        function Game() {
            ...
            _this.state.add("LevelSelection", HappyKittensPuzzle.LevelSelection, false);
...
(function (HappyKittensPuzzle) {
    var GUI = (function (_super) {
        ...
        function GUI(game) {
            ...
            _this.resetButton = new Phaser.Button(_this.game, 20, 900, "texture_atlas_1", _this.onResetClicked, _this);
            ...
            _this.exitButton = new Phaser.Button(_this.game, 120, 900, "texture_atlas_1", _this.onExitClicked, _this);
...
(function (HappyKittensPuzzle) {
    var HUD = (function (_super) {
        ...
        function HUD(game) {
            ...
            _this.levelLabel = new Phaser.Text(_this.game, HappyKittensPuzzle.GameConstants.GAME_WIDTH / 2, 20, "level " + HappyKittensPuzzle.GameVars.currentLevel, { font: "80px Arial", fill: "#ff0000" });
            _this.levelLabel.anchor.x = .5;
            _this.levelLabel.scale.y = HappyKittensPuzzle.GameVars.scaleY;
            _this.add(_this.levelLabel);
            _this.movements = new Phaser.Text(_this.game, 700, 880, "moves  " + HappyKittensPuzzle.GameVars.moves, { font: "60px Arial", fill: "#000000" });
            _this.movements.anchor.x = 1;
            _this.movements.scale.y = HappyKittensPuzzle.GameVars.scaleY;
            ...
            var levelBestStr = levelBest > 0 ? "level's best " + levelBest : "level's best -";
            _this.movementsRecord = new Phaser.Text(_this.game, 700, 950, levelBestStr, { font: "60px Arial", fill: "#000000" });
            _this.movementsRecord.anchor.x = 1;
            _this.movementsRecord.scale.y = HappyKittensPuzzle.GameVars.scaleY;
            _this.add(_this.movementsRecord);
            return _this;
        }
        HUD.prototype.updateMoves = function () {
            this.movements.text = "moves " + HappyKittensPuzzle.GameVars.moves;
        };
        return HUD;
    }(Phaser.Group));
...
(function (HappyKittensPuzzle) {
    var GameManager = (function () {
        ...
        GameManager.levelSelected = function (level) {
            ...
            HappyKittensPuzzle.LevelSelection.currentInstance.goToBoardScene();
        };
...
(function (HappyKittensPuzzle) {
    ...
    HappyKittensPuzzle.LevelSelection = LevelSelection;
})(HappyKittensPuzzle || (HappyKittensPuzzle = {}));
var HappyKittensPuzzle;
(function (HappyKittensPuzzle) {
...
(function (HappyKittensPuzzle) {
    var SplashState = (function (_super) {
        ...
        SplashState.prototype.create = function () {
            var backgroundSprite = this.add.sprite(0, 0, this.game.cache.getBitmapData(HappyKittensPuzzle.GameConstants.GRUMPY));
            backgroundSprite.scale.set(HappyKittensPuzzle.GameConstants.GAME_WIDTH / 64, HappyKittensPuzzle.GameConstants.GAME_HEIGHT / 64);
            var gameTitle = this.add.text(HappyKittensPuzzle.GameConstants.GAME_WIDTH / 2, 190, "Happy Kittens Puzzle", { font: "60px Arial", fill: "#FF1493" });
