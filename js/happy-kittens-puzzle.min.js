...
(function (HappyKittensPuzzle) {
    var Cell = (function (_super) {
        ...
        Cell.prototype.onOver = function () {
            if (HappyKittensPuzzle.GameVars.levelPassed) {
                return;
            }
            this.overImage.visible = true;
            if (this.state === HappyKittensPuzzle.GameConstants.GRUMPY) {
...
(function (HappyKittensPuzzle) {
    var HUD = (function (_super) {
        ...
        function HUD(game) {
            ...
            var movesLabel = new Phaser.Text(_this.game, 300 / HappyKittensPuzzle.GameVars.stripesScale, 5, "MOVES:", { font: "40px Concert One", fill: "#FFFFFF" });
            movesLabel.anchor.x = 1;
            _this.lowerStripe.add(movesLabel);
            _this.moves = new Phaser.Text(_this.game, 330 / HappyKittensPuzzle.GameVars.stripesScale, 5, HappyKittensPuzzle.GameVars.moves.toString(), { font: "40px Concert One", fill: "#FFFFFF" });
            ...
            if (levelBest > 0) {
                var bestLabel = new Phaser.Text(_this.game, 300 / HappyKittensPuzzle.GameVars.stripesScale, 50, "LEVEL'S BEST:", { font: "40px Concert One", fill: "#FFFFFF" });
                bestLabel.anchor.x = 1;
                _this.lowerStripe.add(bestLabel);
                var best = new Phaser.Text(_this.game, 330 / HappyKittensPuzzle.GameVars.stripesScale, 50, levelBest.toString(), { font: "40px Concert One", fill: "#FFFFFF" });
...
(function (HappyKittensPuzzle) {
    var LevelSelectionState = (function (_super) {
        ...
        LevelSelectionState.prototype.create = function () {
            ...
            var audioButton = new HappyKittensPuzzle.AudioButton(this.game, HappyKittensPuzzle.AudioButton.PX / HappyKittensPuzzle.GameVars.stripesScale, HappyKittensPuzzle.AudioButton.PY);
            yellowStripe.add(audioButton);
