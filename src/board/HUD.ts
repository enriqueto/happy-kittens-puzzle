namespace HappyKittensPuzzle {
    ...
    export class HUD extends Phaser.Group {
        ...
        constructor(game: Phaser.Game) {
            ...
            const movesLabel: Phaser.Text = new Phaser.Text(this.game, 300 / GameVars.stripesScale, 5, "MOVES:", { font: "40px Concert One", fill: "#FFFFFF"});
            movesLabel.anchor.x = 1;
            this.lowerStripe.add(movesLabel);

            this.moves = new Phaser.Text(this.game, 330 / GameVars.stripesScale, 5, GameVars.moves.toString(), { font: "40px Concert One", fill: "#FFFFFF"});
            ...
            if (levelBest > 0) {
                ...
                const bestLabel: Phaser.Text = new Phaser.Text(this.game, 300 / GameVars.stripesScale, 50, "LEVEL'S BEST:", { font: "40px Concert One", fill: "#FFFFFF"});
                bestLabel.anchor.x = 1;
                this.lowerStripe.add(bestLabel);

                const best: Phaser.Text = new Phaser.Text(this.game, 330 / GameVars.stripesScale, 50,  levelBest.toString(), { font: "40px Concert One", fill: "#FFFFFF"});
