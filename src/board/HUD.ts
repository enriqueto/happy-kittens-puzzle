namespace HappyKittensPuzzle {
    ...
    export class HUD extends Phaser.Group {
        ...
        constructor(game: Phaser.Game) {
            ...
            this.levelLabel = new Phaser.Text(this.game, GameConstants.GAME_WIDTH / 2, 20, "level " + GameVars.currentLevel, { font: "80px Arial", fill: "#000000"});
            this.levelLabel.anchor.x = .5;
            this.levelLabel.scale.y = GameVars.scaleY;
            this.add(this.levelLabel);

            this.movements = new Phaser.Text(this.game, 430, 880, "moves  " + GameVars.moves, { font: "30px Arial", fill: "#000000"});
            ...
            this.movementsRecord  = new Phaser.Text(this.game, 430, 950, levelBestStr, { font: "30px Arial", fill: "#000000"});
